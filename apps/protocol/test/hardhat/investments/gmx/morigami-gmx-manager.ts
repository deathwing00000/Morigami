...
describe("Morigami GMX Manager", async () => {
  ...
  describe("Local setup", async () => {
    async function setupMorigamiGmxManager() {
      ...
      oGmxToken = await new DummyMintableToken__factory(gov).deploy(
        govAddr,
        "oGMX",
        "oGMX",
        18
      );
      oGlpToken = await new DummyMintableToken__factory(gov).deploy(
        govAddr,
        "oGLP",
        "oGLP",
        18
      ...
      await origamiGmxManager.setRewardsAggregators(
        origamiGmxRewardsAggr.getAddress(),
        origamiGlpRewardsAggr.getAddress()
      );
      await origamiGlpManager.setRewardsAggregators(
        origamiGmxRewardsAggr.getAddress(),
        origamiGlpRewardsAggr.getAddress()
      );
    ...
    describe("Admin", async () => {
      it("Construction", async () => {
        expect(await origamiGmxManager.glpManager()).eq(
          await gmxContracts.glpRewardRouter.glpManager()
        );
        expect(await origamiGmxManager.gmxToken()).eq(
          gmxContracts.gmxToken.address
        );
        expect(await origamiGmxManager.glpToken()).eq(
          gmxContracts.glpToken.address
        );
        expect(await origamiGmxManager.wrappedNativeToken()).eq(
        ...
        expect(await origamiGmxManager.gmxVault()).eq(
          gmxContracts.vault.address
        );

        expect(await origamiGmxManager.rewardTokensList()).deep.eq([
          gmxContracts.wrappedNativeToken.address,
          oGmxToken.address,
          oGlpToken.address,
        ]);
        expect(await origamiGmxManager.feeCollector()).eq(
          await feeCollector.getAddress()
        );

        expect(await origamiGmxManager.primaryEarnAccount()).eq(
          gmxEarnAccount.address
        );
        expect(await origamiGmxManager.secondaryEarnAccount()).eq(ZERO_ADDRESS);
        expect(await origamiGlpManager.primaryEarnAccount()).eq(
          glpPrimaryEarnAccount.address
        );
        expect(await origamiGlpManager.secondaryEarnAccount()).eq(
          glpSecondaryEarnAccount.address
        );
        expect(await origamiGmxManager.gmxRewardsAggregator()).eq(
          await origamiGmxRewardsAggr.getAddress()
        );
        expect(await origamiGmxManager.glpRewardsAggregator()).eq(
          await origamiGlpRewardsAggr.getAddress()
        );
      });
      ...
      it("admin", async () => {
        await shouldRevertInvalidAccess(
          origamiGmxManager,
          origamiGmxManager.connect(owner).setOGmxRewardsFeeRate(0)
        );
        await shouldRevertInvalidAccess(
          origamiGmxManager,
          origamiGmxManager.connect(owner).setEsGmxVestingRate(0)
        );
        await shouldRevertInvalidAccess(
          origamiGmxManager,
          origamiGmxManager.connect(owner).setSellFeeRate(0)
        );
        await shouldRevertInvalidAccess(
          origamiGmxManager,
          origamiGmxManager.connect(owner).setFeeCollector(ZERO_ADDRESS)
        );
        await shouldRevertInvalidAccess(
          origamiGmxManager,
          origamiGmxManager.connect(owner).setPrimaryEarnAccount(ZERO_ADDRESS)
        );
        await shouldRevertInvalidAccess(
          origamiGmxManager,
          origamiGmxManager.connect(owner).setSecondaryEarnAccount(ZERO_ADDRESS)
        );
        await shouldRevertInvalidAccess(
          origamiGmxManager,
          origamiGmxManager
            .connect(owner)
            .setRewardsAggregators(ZERO_ADDRESS, ZERO_ADDRESS)
        );
        await shouldRevertInvalidAccess(
          origamiGmxManager,
          origamiGmxManager
            .connect(alan)
            .recoverToken(gmxContracts.bnbToken.address, alan.getAddress(), 10)
        );
        const paused = {
        ...
        await shouldRevertInvalidAccess(
          origamiGmxManager,
          origamiGmxManager.connect(alan).setPauser(alan.getAddress(), true)
        );
        ...
        const investGmxQuote = await origamiGmxManager.investOGmxQuote(
          100,
          gmxContracts.gmxToken.address,
          ZERO_SLIPPAGE,
          ZERO_DEADLINE
        );
        const exitGmxQuote = await origamiGmxManager.exitOGmxQuote(
          100,
          gmxContracts.gmxToken.address,
          ZERO_SLIPPAGE,
          ZERO_DEADLINE
        ...
        await shouldRevertInvalidAccess(
          ...
          origamiGmxManager
            .connect(alan)
            .exitOGmx(exitGmxQuote.quoteData, ZERO_ADDRESS)
        );

        const investGlpQuote = await origamiGmxManager.investOGlpQuote(
          100,
          gmxContracts.bnbToken.address,
          ZERO_SLIPPAGE,
          ZERO_DEADLINE
        );
        const exitGlpQuote = await origamiGmxManager.exitOGlpQuote(
          100,
          gmxContracts.bnbToken.address,
          ZERO_SLIPPAGE,
          ZERO_DEADLINE
        ...
        await shouldRevertInvalidAccess(
          ...
          origamiGmxManager
            .connect(alan)
            .investOGlp(gmxContracts.bnbToken.address, investGlpQuote.quoteData)
        );
        await shouldRevertInvalidAccess(
          origamiGmxManager,
          origamiGmxManager
        ...
        // Happy Paths
        await origamiGmxManager.connect(gov).setOGmxRewardsFeeRate(100);
        await origamiGmxManager.connect(gov).setEsGmxVestingRate(100);
        await origamiGmxManager.connect(gov).setSellFeeRate(100);
        await origamiGmxManager
          .connect(gov)
          .setFeeCollector(feeCollector.getAddress());
        await origamiGmxManager
          .connect(gov)
          .setPrimaryEarnAccount(gmxEarnAccount.address);
        await origamiGmxManager
          .connect(gov)
          .setSecondaryEarnAccount(gmxEarnAccount.address);
        await origamiGmxManager
          .connect(gov)
          .setRewardsAggregators(
            origamiGmxRewardsAggr.getAddress(),
            origamiGlpRewardsAggr.getAddress()
          );
        await expect(
          origamiGmxManager.recoverToken(
            gmxContracts.bnbToken.address,
            alan.getAddress(),
            10
          )
        ...
        await expect(
          origamiGmxManager.connect(operator).applyGmx(0)
        ...
        await expect(
          origamiGmxManager
            .connect(operator)
            .investOGmx(investGmxQuote.quoteData)
      ...
      it("gov can set pauser", async () => {
        ...
        await origamiGmxManager.connect(alan).setPaused(paused);
        expect(
          await origamiGmxManager.connect(alan).pausers(alan.getAddress())
        ).eq(true);
      ...
      it("pause/unpause", async () => {
        ...
        const checkPaused = (
          actual: IMorigamiGmxManager.PausedStructOutput,
          expected: IMorigamiGmxManager.PausedStruct
        ) => {
      ...
      it("Should setOGmxRewardsFeeRate()", async () => {
        await expect(
          origamiGmxManager.setOGmxRewardsFeeRate(10_001)
        ).to.revertedWithCustomError(origamiGmxManager, "InvalidParam");

        await expect(origamiGmxManager.setOGmxRewardsFeeRate(80))
          .to.emit(origamiGmxManager, "OGmxRewardsFeeRateSet")
          .withArgs(80);
        const numerator = await origamiGmxManager.oGmxRewardsFeeRate();
        expect(numerator.toNumber()).to.eq(80);
      });

      it("Should setEsGmxVestingRate()", async () => {
        await expect(
          origamiGmxManager.setEsGmxVestingRate(10_001)
        ).to.revertedWithCustomError(origamiGmxManager, "InvalidParam");

        await expect(origamiGmxManager.setEsGmxVestingRate(80))
          .to.emit(origamiGmxManager, "EsGmxVestingRateSet")
          .withArgs(80);
        const numerator = await origamiGmxManager.esGmxVestingRate();
        expect(numerator.toNumber()).to.eq(80);
      });

      it("Should setSellFeeRate()", async () => {
        await expect(
          origamiGmxManager.setSellFeeRate(10_001)
        ).to.revertedWithCustomError(origamiGmxManager, "InvalidParam");

        await expect(origamiGmxManager.setSellFeeRate(80))
          .to.emit(origamiGmxManager, "SellFeeRateSet")
          .withArgs(80);
        const numerator = await origamiGmxManager.sellFeeRate();
        expect(numerator.toNumber()).to.eq(80);
      });
      ...
      it("Should setPrimaryEarnAccount()", async () => {
        await expect(origamiGmxManager.setPrimaryEarnAccount(ZERO_ADDRESS))
          ...
          .withArgs(ZERO_ADDRESS);
        await expect(
          origamiGmxManager.setPrimaryEarnAccount(gmxEarnAccount.address)
        )
      ...
      it("Should setSecondaryEarnAccount()", async () => {
        await expect(origamiGmxManager.setSecondaryEarnAccount(ZERO_ADDRESS)).to
          .not.be.reverted;
        await expect(
          origamiGmxManager.setSecondaryEarnAccount(gmxEarnAccount.address)
        )
          .to.emit(origamiGmxManager, "SecondaryEarnAccountSet")
          .withArgs(gmxEarnAccount.address);
        expect(await origamiGmxManager.secondaryEarnAccount()).eq(
          gmxEarnAccount.address
        );
      });
      ...
      it("Should setRewardsAggregators()", async () => {
        await expect(
          origamiGmxManager.setRewardsAggregators(
            ZERO_ADDRESS,
            origamiGlpRewardsAggr.getAddress()
          )
        )
    ...
    describe("applyGmx", async () => {
      it("should applyGmx() by staking", async () => {
        ...
        await expect(
          origamiGmxManager.connect(operator).applyGmx(amount)
        ...
        expect(
          await gmxContracts.gmxToken.balanceOf(origamiGmxManager.address)
        ).eq(0);
        expect(
          await gmxContracts.gmxToken.balanceOf(gmxEarnAccount.address)
        ).eq(0);

        // The earn account has the staked GMX
        expect(
          await gmxContracts.stakedGmxTracker.stakedAmounts(
            gmxEarnAccount.address
          )
        ).eq(amount);
      });
    ...
    describe("Rewards", async () => {
      it("harvestableRewards", async () => {
        ...
        let rewardRatesGlp = await origamiGmxManager.harvestableRewards(
          GmxVaultType.GLP
        );
        let rewardRatesGmx = await origamiGmxManager.harvestableRewards(
          GmxVaultType.GMX
        );
        ...
        rewardRatesGlp = await origamiGmxManager.harvestableRewards(
          GmxVaultType.GLP
        );
        rewardRatesGmx = await origamiGmxManager.harvestableRewards(
          GmxVaultType.GMX
        );
        expect(rewardRatesGlp).deep.eq([0, 0, 0]);
        expect(rewardRatesGmx).deep.eq([
          ethPerSecond.mul(86400),
          esGmxPerSecond.mul(86400),
          0,
        ]);
      ...
      it("harvestRewards - GMX - no vesting", async () => {
        ...
        let ethRewards;
        {
          ...
          await mineForwardSeconds(86400);
          let rewardRates = await origamiGmxManager.harvestableRewards(
            GmxVaultType.GMX
          );
          ...
          await expect(origamiGmxManager.connect(operator).harvestRewards())
            .to.emit(gmxEarnAccount, "RewardsHarvested")
            .withArgs(
              expectApproxEqRelPred(expectedEth, MAX_REL_DELTA),
              0, // ETH from GMX, 0 from GLP
              expectApproxEqRelPred(expectedEsGmx, MAX_REL_DELTA),
              0, // oGMX, 0 from GLP
              0, // GMX vested
          ...
          oGmxRewards = await oGmxToken.balanceOf(
            origamiGmxRewardsAggr.getAddress()
          );
          ...
          ethFees = await gmxContracts.wrappedNativeToken.balanceOf(
            feeCollector.getAddress()
          );
          ethRewards = await gmxContracts.wrappedNativeToken.balanceOf(
            origamiGmxRewardsAggr.getAddress()
          );
          expect(ethFees).eq(0);
        ...
        // With fees
        {
          ...
          // The oGMX gets minted
          const oGmxFees2 = await oGmxToken.balanceOf(
            feeCollector.getAddress()
          );
          const oGmxRewards2 = await oGmxToken.balanceOf(
            origamiGmxRewardsAggr.getAddress()
          );
          expect(oGmxRewards2).gte(
            oGmxRewards.add(expectedEsGmx.mul(70).div(100)).sub(1)
          ); // slight rounding diff
          expect(oGmxFees2).gte(oGmxFees.add(expectedEsGmx.mul(30).div(100)));

          // The ETH/AVAX gets transferred
          const ethFees2 = await gmxContracts.wrappedNativeToken.balanceOf(
            feeCollector.getAddress()
          );
          const ethRewards2 = await gmxContracts.wrappedNativeToken.balanceOf(
            origamiGmxRewardsAggr.getAddress()
          );
          expect(ethRewards2).gte(
            ethRewards.add(expectedEth.mul(90).div(100)).sub(1)
          ); // slight rounding diff
      ...
      it("harvestRewards - GMX - no vesting - 100% fees", async () => {
        ...
        {
          await mineForwardSeconds(86400);
          const harvestableRewards = await origamiGmxManager.harvestableRewards(
            GmxVaultType.GMX
          );
          ...
          await expect(origamiGmxManager.connect(operator).harvestRewards())
            ...
            .withArgs(
              expectApproxEqRelPred(expectedEth, MAX_REL_DELTA),
              0, // ETH for GMX, 0 for GLP
              expectApproxEqRelPred(expectedEsGmx, MAX_REL_DELTA),
              0, // oGMX for GMX, 0 for GLP
              0, // GMX vested
              0 // esGMX deposited into vesting
            );
          ...
          const oGmxRewards = await oGmxToken.balanceOf(
            origamiGmxRewardsAggr.getAddress()
          );
          ...
          // The ETH/AVAX gets transferred
          const ethFees = await gmxContracts.wrappedNativeToken.balanceOf(
            feeCollector.getAddress()
          );
          const ethRewards = await gmxContracts.wrappedNativeToken.balanceOf(
            origamiGmxRewardsAggr.getAddress()
          );
          expect(ethFees).eq(0);
          expect(ethRewards).gte(expectedEth);
      ...
      it("harvestRewards - GMX - with vesting", async () => {
        ...
        let ethRewards;
        {
          ...
          await expect(origamiGmxManager.connect(operator).harvestRewards())
            ...
            .withArgs(
              ...
              0, // GMX vested
              expectApproxEqRelPred(
                expectedEsGmx.mul(30).div(100),
                MAX_REL_DELTA
              ) // esGMX deposited into vesting
            );
        ...
        // Second time - now the vested GMX is ready to be applied too
        {
          ...
          expectedEth = ethPerSecond.mul(86401);
          expectedEsGmx = esGmxPerSecond.mul(86401);
          const expectedVestedGmx = expectedEsGmx
            .mul(30)
            .div(100)
            .mul(86401)
            .div(oneYear);
          ...
          ).gte(amount.add(expectedVestedGmx));
        }
      });
      ...
      it("harvestRewards - GLP", async () => {
        ...
        const quote = await origamiGmxManager.investOGlpQuote(
          amount,
          tokenAddr,
          ZERO_SLIPPAGE,
          ZERO_DEADLINE
        ...
        let ethRewardsGmx;
        {
          ...
          await expect(origamiGmxManager.connect(operator).harvestRewards())
            ...
            .withArgs(
              0,
              expectApproxEqRelPred(expectedEth, MAX_REL_DELTA), // ETH only from GLP
              0,
              expectApproxEqRelPred(expectedEsGmx, MAX_REL_DELTA), // oGMX only from GLP
              0, // esGMX vesting
              0 // vested GMX
            );
          ...
          // The oGMX gets minted
          oGmxFees = await oGmxToken.balanceOf(feeCollector.getAddress());
          oGmxRewardsGlp = await oGmxToken.balanceOf(
            origamiGlpRewardsAggr.getAddress()
          );
          oGmxRewardsGmx = await oGmxToken.balanceOf(
            origamiGmxRewardsAggr.getAddress()
          );
          expect(oGmxFees).eq(0);
          ...
          ethRewardsGlp = await gmxContracts.wrappedNativeToken.balanceOf(
            origamiGlpRewardsAggr.getAddress()
          );
          ethRewardsGmx = await gmxContracts.wrappedNativeToken.balanceOf(
            origamiGmxRewardsAggr.getAddress()
          );
          expect(ethFees).eq(0);
        ...
        // but Morigami has 100% of both.
        {
          ...
          await expect(origamiGmxManager.connect(operator).harvestRewards())
            ...
            .withArgs(
              expectApproxEqRelPred(expectedEth, MAX_REL_DELTA),
              expectApproxEqRelPred(expectedEth, MAX_REL_DELTA), // ETH
              expectApproxEqRelPred(expectedEsGmx, MAX_REL_DELTA),
              expectApproxEqRelPred(expectedEsGmx, MAX_REL_DELTA), // oGMX
              0, // esGMX vested
              0 // vested GMX
            );
          ...
          const oGmxRewards2Glp = await oGmxToken.balanceOf(
            origamiGlpRewardsAggr.getAddress()
          );
          const oGmxRewards2Gmx = await oGmxToken.balanceOf(
            origamiGmxRewardsAggr.getAddress()
          );
          ...
          const ethRewards2Glp =
            await gmxContracts.wrappedNativeToken.balanceOf(
              origamiGlpRewardsAggr.getAddress()
            );
          const ethRewards2Gmx =
            await gmxContracts.wrappedNativeToken.balanceOf(
              origamiGmxRewardsAggr.getAddress()
            );
      ...
      it("harvestRewards - GLP - no vesting - 100% fees", async () => {
        await origamiGlpManager.setOGmxRewardsFeeRate(10_000);
        ...
        {
          await mineForwardSeconds(86400);
          let harvestableRewardsGlp =
            await origamiGlpManager.harvestableRewards(GmxVaultType.GLP);
      ...
      it("harvestSecondaryRewards - GLP - 50% fees", async () => {
        await origamiGlpManager.setOGmxRewardsFeeRate(5_000);
...

        {
          await mineForwardSeconds(86400);
          let rewardRatesGlp =
            await origamiGlpManager.harvestableSecondaryRewards(
              GmxVaultType.GLP
            );
          const expectedEth = ethPerSecond.mul(86400);
      ...
      it("Should get projectedRewardRates()", async () => {
        ...
        let rewardRatesGlp = await origamiGmxManager.projectedRewardRates(
          GmxVaultType.GLP
        );
        let rewardRatesGmx = await origamiGmxManager.projectedRewardRates(
          GmxVaultType.GMX
        );
        expect(rewardRatesGlp).deep.eq([0, 0, 0]);
        expect(rewardRatesGmx).deep.eq([0, 0, 0]);
        ...
        rewardRatesGlp = await origamiGmxManager.projectedRewardRates(
          GmxVaultType.GLP
        );
        rewardRatesGmx = await origamiGmxManager.projectedRewardRates(
          GmxVaultType.GMX
        );
        expect(rewardRatesGlp).deep.eq([0, 0, 0]);
    ...
    describe("GLP Quotes - dummy vault", async () => {
      ...
      async function checkBuyQuote(
        ...
        const expectedUsdg = amount
          .mul(price)
          .mul(basisPointsDivisor - expectedFee)
          .div(basisPointsDivisor);

        // GLP the same as USDG since it hasn't appreciated (ie glpSupply == aumInUsdg)
        const expectedGlp = expectedUsdg;
        const glpResults = await origamiGmxManager.investOGlpQuote(
          amount,
          gmxContracts.bnbToken.address,
          100,
          ZERO_DEADLINE
        ...
        expect(glpResults.quoteData.minInvestmentAmount).eq(
          applySlippage(expectedGlp, 100)
        );
        return glpResults;
      }
      ...
      async function checkSellQuote(
        ...
        const expectedUsdg = redemptionAmount
          .mul(basisPointsDivisor - expectedFee)
          .div(basisPointsDivisor);
        const expectedGlp = expectedUsdg;

        // GLP the same as USDG since it hasn't appreciated (ie glpSupply == aumInUsdg)
        const glpResults = await origamiGmxManager.exitOGlpQuote(
          amount,
          gmxContracts.bnbToken.address,
          100,
          ZERO_DEADLINE
        ...
        if ((await gmxContracts.glpToken.totalSupply()).eq(0)) {
          ...
          expect(glpResults.quoteData.minToTokenAmount).eq(
            applySlippage(expectedGlp, 100)
          );
        }
      ...
      it("Buy Glp Quote - non-accepted token", async () => {
        ...
        await expect(
          origamiGmxManager.investOGlpQuote(
            BigNumber.from(100),
            randomAddress,
            ZERO_SLIPPAGE,
            ZERO_DEADLINE
        ...
        await expect(
          origamiGmxManager.exitOGlpQuote(
            BigNumber.from(100),
            randomAddress,
            ZERO_SLIPPAGE,
            ZERO_DEADLINE
      ...
      it("Buy Glp Quote - empty GMX vault", async () => {
        const price = 300;
        await expect(
          checkBuyQuote(BigNumber.from(0), price, 0)
  ...
  describe.skip("GLP Quotes - forked Arbi Mainnet (SLOW!!)", async () => {
    ...
    it("Buy/Sell GLP Quotes should match actual buy and sell amounts", async () => {
      ...
      const largeLinkHolder = await impersonateSigner(
      ...
      await gmxContracts.bnbToken
        .connect(largeLinkHolder)
        .transfer(bob.getAddress(), amount);
      await gmxContracts.bnbToken.connect(bob).approve(glpManagerAddr, amount);
      expect(await gmxContracts.bnbToken.balanceOf(bob.getAddress())).eq(
        amount
      );

      // Get a quote to buy GLP
      const buyQuote = await origamiGmxManager.investOGlpQuote(
        amount,
        gmxContracts.bnbToken.address,
        ZERO_SLIPPAGE,
        ZERO_DEADLINE
      ...
      await expect(
        gmxContracts.glpRewardRouter
          .connect(bob)
          .mintAndStakeGlp(
            gmxContracts.bnbToken.address,
            amount,
            MIN_USDG,
            buyQuote.quoteData.minInvestmentAmount
          )
      )
        .emit(gmxContracts.glpRewardRouter, "StakeGlp")
        .withArgs(
          await bob.getAddress(),
          buyQuote.quoteData.expectedInvestmentAmount
        );

      // Alan has a staked GLP balance
      const stakedGlpBal = await gmxContracts.stakedGlpTracker.balanceOf(
        bob.getAddress()
      );
      ...
      const sellQuote = await origamiGmxManager.exitOGlpQuote(
        stakedGlpBal,
        gmxContracts.bnbToken.address,
        ZERO_SLIPPAGE,
        ZERO_DEADLINE
      ...
      await expect(
        gmxContracts.glpRewardRouter
          ...
          .unstakeAndRedeemGlp(
            gmxContracts.bnbToken.address,
            stakedGlpBal,
            sellQuote.quoteData.minToTokenAmount,
            bob.getAddress()
          )
      )
        .emit(gmxContracts.glpRewardRouter, "UnstakeGlp")
        .withArgs(await bob.getAddress(), stakedGlpBal);

      // Alan receives the correct BNB back, matching the quote
      expect(await gmxContracts.bnbToken.balanceOf(bob.getAddress())).eq(
        sellQuote.quoteData.expectedToTokenAmount
      );
    });
  });
});
