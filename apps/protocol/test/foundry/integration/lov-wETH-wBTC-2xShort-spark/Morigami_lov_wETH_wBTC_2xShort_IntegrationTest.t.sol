...
import {Morigami_lov_wETH_wBTC_2xShort_IntegrationTestBase} from "test/foundry/integration/lov-wETH-wBTC-2xShort-spark/Morigami_lov_wETH_wBTC_2xShort_IntegrationTestBase.t.sol";
import {Morigami_lovToken_TestConstants as Constants} from "test/foundry/deploys/lov-wETH-wBTC-2xShort-spark/Morigami_lovToken_TestConstants.t.sol";
...
contract Morigami_lov_wETH_wBTC_2xShort_IntegrationTest is
    Morigami_lov_wETH_wBTC_2xShort_IntegrationTestBase
{
    ...
    function test_lovToken_invest_success() public {
...

        {
            assertEq(
                ...
                expectedAmountOut * decimalsScale
            );
            assertEq(
    ...
    function test_lovToken_rebalanceDown_success() public {
        ...
        // 1Inch implied price
        assertApproxEqRel(
            (reservesAmount * 1e18) / params.flashLoanAmount,
            expectedSwapPrice,
            1e15
        );
    ...
    function test_lovToken_shutdown() public {
        ...
        assertEq(
            ...
            0.991280277831187417e18
        );
    }
}

contract Morigami_lov_wETH_wBTC_2xShort_IntegrationTest_PegControls is
    Morigami_lov_wETH_wBTC_2xShort_IntegrationTestBase
{
    uint256 decimalsScale =
        10 ** (Constants.WETH_DECIMALS - Constants.WBTC_DECIMALS);
