...
import {Morigami_lov_ezETH_wETH_IntegrationTestBase} from "test/foundry/integration/lov-ezETH-wETH/Morigami_lov_ezETH_wETH_IntegrationTestBase.t.sol";
...
contract Morigami_lov_ezETH_wETH_IntegrationTest is
    Morigami_lov_ezETH_wETH_IntegrationTestBase
{
    ...
    function test_lov_ezETH_wETH_initialization() public {
...

        {
            ...
            assertEq(
                ...
                address(lovTokenContracts.ezEthToEthOracle)
            );
        }

        {
            assertEq(
                address(lovTokenContracts.ezEthToEthOracle.owner()),
                origamiMultisig
            );
            assertEq(
                lovTokenContracts.ezEthToEthOracle.description(),
                "ezETH/wETH"
            );
            ...
            assertEq(
                address(lovTokenContracts.ezEthToEthOracle.spotPriceOracle()),
            ...
            assertEq(
                lovTokenContracts.ezEthToEthOracle.spotPricePrecisionScalar(),
                1e10
            ...
            assertEq(
                address(
                    lovTokenContracts.ezEthToEthOracle.renzoRestakeManager()
                ),
                Constants.RENZO_RESTAKE_MANAGER
            );
            assertEq(
                lovTokenContracts.ezEthToEthOracle.maxRelativeToleranceBps(),
                30
            );
        }

        {
            ...
            assertEq(
                ...
                hex"49bb2d114be9041a787432952927f6f144f05ad3e83196a7d062f374ee11d0ee"
            );
    ...
    function test_lov_ezETH_wETH_invest_success() public {
...

        {
            ...
            assertEq(
                externalContracts.ezEthToken.balanceOf(
                    address(lovTokenContracts.lovTokenManager)
                ),
                0
            );
    ...
    function test_lov_ezETH_wETH_rebalanceDown_success() public {
        ...
        assertEq(
            lovTokenContracts.ezEthToEthOracle.latestPrice(
                IMorigamiOracle.PriceType.SPOT_PRICE,
...

        {
            ...
            assertEq(
                ...
                15.040669200512086449e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.userRedeemableReserves(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
                ),
                15.052883326286605682e18
            );
        }
    }
    ...
    function test_lov_ezETH_wETH_rebalanceUp_success() public {
...

        {
            ...
            assertEq(
                lovTokenContracts.lovTokenManager.assetToLiabilityRatio(),
                1.299778677507019972e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.liabilities(
                    IMorigamiOracle.PriceType.SPOT_PRICE
                ),
                50.144100938189941257e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.liabilities(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
                ),
                50.133893165594787259e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.reservesBalance(),
                65.176233202219041276e18
            );
            assertEq(
                lovTokenContracts.borrowLend.suppliedBalance(),
                65.176233202219041276e18
            ...
            assertEq(
                lovTokenContracts.borrowLend.debtBalance(),
                50.545030103005276459e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.userRedeemableReserves(
                    IMorigamiOracle.PriceType.SPOT_PRICE
                ),
                15.032132264029100019e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.userRedeemableReserves(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
                ),
                15.042340036624254017e18
            );
    ...
    function test_lov_ezETH_wETH_shutdown() public {
        ...
        assertEq(
            ...
            0.908253019570339394e18
        );
    }
}

contract Morigami_lov_ezETH_wETH_IntegrationTest_PegControls is
    Morigami_lov_ezETH_wETH_IntegrationTestBase
{
    ...
    function test_lov_ezETH_wETH_invest_fail_peg_controls() public {
        ...
        vm.startPrank(alice);
        externalContracts.ezEthToken.approve(
            address(lovTokenContracts.lovToken),
            amount
        );
    ...
    function test_latestPrices() public {
        (
            ...
            address baseAsset,
            address quoteAsset
        ) = lovTokenContracts.ezEthToEthOracle.latestPrices(
                IMorigamiOracle.PriceType.SPOT_PRICE,
