...
import {Morigami_lov_wstETH_wETH_IntegrationTestBase} from "test/foundry/integration/lov-wstETH-wETH-spark/Morigami_lov_wstETH_wETH_IntegrationTestBase.t.sol";
    ...
    Morigami_lov_wstETH_wETH_IntegrationTestBase
{
    ...
    function test_lovWstEth_initialization() public {
...

        {
            ...
            assertEq(
                address(lovTokenContracts.lovWstEthManager.flashLoanProvider()),
            ...
            assertEq(
                address(lovTokenContracts.lovWstEthManager.swapper()),
    ...
    function test_lovWstEth_rebalanceDown_success() public {
...

        {
            ...
            assertEq(
                ...
                49.895276763268114786e18
            );
            assertEq(
                lovTokenContracts.lovWstEthManager.userRedeemableReserves(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
                ),
                50.015306025955314917e18
            );
        }
    }
    ...
    function test_lovWstEth_rebalanceUp_success() public {
...

        {
            ...
            assertEq(
                lovTokenContracts.lovWstEthManager.assetToLiabilityRatio(),
                1.130003678341790707e18
            );
            assertEq(
                lovTokenContracts.lovWstEthManager.liabilities(
                    IMorigamiOracle.PriceType.SPOT_PRICE
                ),
                383.808571893864655879e18
            );
            assertEq(
                lovTokenContracts.lovWstEthManager.liabilities(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
                ),
                383.693401244121036334e18
            );
            assertEq(
                lovTokenContracts.lovWstEthManager.reservesBalance(),
                433.705098019176690062e18
            );
            assertEq(
                lovTokenContracts.borrowLend.suppliedBalance(),
                433.705098019176690062e18
            ...
            assertEq(
                lovTokenContracts.borrowLend.debtBalance(),
                444.013802290630169178e18
            );
            assertEq(
                lovTokenContracts.lovWstEthManager.userRedeemableReserves(
                    IMorigamiOracle.PriceType.SPOT_PRICE
                ),
                49.896526125312034183e18
            );
            assertEq(
                lovTokenContracts.lovWstEthManager.userRedeemableReserves(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
                ),
                50.011696775055653728e18
            );
    ...
    function test_lovWstEth_shutdown() public {
        ...
        params.flashLoanAmount =
            lovTokenContracts.borrowLend.debtBalance() +
            1e18;
        (params.collateralToWithdraw, params.swapData) = swapWEthToWstEthQuote(
            params.flashLoanAmount
        );
        (params.flashLoanAmount, params.swapData) = swapWstEthToWEthQuote(
