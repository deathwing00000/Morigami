...
import {ExternalContracts, LovTokenContracts, Morigami_lov_wstETH_wETH_TestDeployer as Deployer} from "test/foundry/deploys/lov-wstETH-wETH-spark/Morigami_lov_wstETH_wETH_TestDeployer.t.sol";
...
contract Morigami_lov_wstETH_wETH_IntegrationTestBase is MorigamiTest {
    ...
    function setUp() public virtual {
        ...
        // aToken = MorigamiAaveV3IdleStrategy(address(oUsdcContracts.idleStrategy)).aToken();
    }
        ...
        )
    {
        ...
        params.flashLoanAmount = lovTokenContracts
            .wstEthToEthOracle
            .convertAmount(
                address(externalContracts.wstEthToken),
                reservesAmount,
        ...
        params.minExpectedReserveToken = reservesAmount.subtractBps(
            swapSlippageBps,
            MorigamiMath.Rounding.ROUND_DOWN
        );
    }
        ...
        )
    {
        ...
        uint256 feeBps = 0;
        params.flashLoanAmount = params.flashLoanAmount.inverseSubtractBps(
            feeBps,
