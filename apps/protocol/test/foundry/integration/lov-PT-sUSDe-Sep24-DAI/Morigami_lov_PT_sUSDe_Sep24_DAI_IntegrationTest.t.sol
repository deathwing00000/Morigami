...
import {Morigami_lov_PT_sUSDe_Sep24_DAI_IntegrationTestBase} from "test/foundry/integration/lov-PT-sUSDe-Sep24-DAI/Morigami_lov_PT_sUSDe_Sep24_DAI_IntegrationTestBase.t.sol";
...
contract Morigami_lov_PT_sUSDe_Sep24_DAI_IntegrationTest is
    Morigami_lov_PT_sUSDe_Sep24_DAI_IntegrationTestBase
{
    ...
    function test_lov_PT_sUSDe_Sep24_DAI_initialization() public {
...

        {
            ...
            assertEq(
                ...
                address(lovTokenContracts.ptSUsdeToDaiOracle)
            );
        }

        {
            assertEq(
                lovTokenContracts.ptSUsdeToDaiOracle.description(),
                "PT-sUSDe-Sep24/DAI"
            );
            ...
            assertEq(
                address(lovTokenContracts.ptSUsdeToDaiOracle.baseAssetOracle()),
                address(lovTokenContracts.ptSUsdeToUSDeOracle)
            );
            assertEq(
                address(
                    lovTokenContracts.ptSUsdeToDaiOracle.quoteAssetOracle()
                ),
                address(lovTokenContracts.usdeToDaiOracle)
            );
            assertEq(
                address(
                    lovTokenContracts.ptSUsdeToDaiOracle.priceCheckOracle()
                ),
                address(0)
            );
...

        {
            ...
            assertEq(
                ...
                hex"b5a5be93ba0c635e2106ba81fc883cfeb6971eaa22fa4fae1d539c73b9ee7bf6"
            );
    ...
    function test_lov_PT_sUSDe_Sep24_DAI_invest_success() public {
...

        {
            ...
            assertEq(
                externalContracts.ptSUSDeToken.balanceOf(
                    address(lovTokenContracts.lovTokenManager)
                ),
                0
            );
    ...
    function test_lov_PT_sUSDe_Sep24_DAI_rebalanceDown_success() public {
        ...
        assertEq(
            lovTokenContracts.ptSUsdeToDaiOracle.latestPrice(
                IMorigamiOracle.PriceType.SPOT_PRICE,
                MorigamiMath.Rounding.ROUND_DOWN
            ),
            0.968926899735307909e18
        );
...

        {
            ...
            assertEq(
                lovTokenContracts.lovTokenManager.assetToLiabilityRatio(),
                1.242107501761333594e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.liabilities(
                    IMorigamiOracle.PriceType.SPOT_PRICE
                ),
                206_434.563902438477097710e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.liabilities(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
                ),
                206_270.877808028955550632e18
            );
            ...
            assertEq(
                ...
                49_979.356543609756152290e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.userRedeemableReserves(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
                ),
                50_143.042638019277699368e18
            );
        }
    }
    ...
    function test_lov_PT_sUSDe_Sep24_DAI_rebalanceUp_success() public {
...

        {
            ...
            assertEq(
                lovTokenContracts.lovTokenManager.assetToLiabilityRatio(),
                1.247791376154354412e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.liabilities(
                    IMorigamiOracle.PriceType.SPOT_PRICE
                ),
                197_392.659777620030594070e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.liabilities(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
                ),
                197_236.143189829160090899e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.reservesBalance(),
                246_304.858586684779994880e18
            );
            assertEq(
                lovTokenContracts.borrowLend.suppliedBalance(),
                246_304.858586684779994880e18
            ...
            assertEq(
                lovTokenContracts.borrowLend.debtBalance(),
                191_259.057868835789756827e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.userRedeemableReserves(
                    IMorigamiOracle.PriceType.SPOT_PRICE
                ),
                48_912.198809064749400810e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.userRedeemableReserves(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
                ),
                49_068.715396855619903981e18
            );
    ...
    function test_lov_PT_sUSDe_Sep24_DAI_exit_fail_al_limit() public {
...

        {
            ...
            assertEq(
                lovTokenContracts.lovTokenManager.assetToLiabilityRatio(),
                (Constants.USER_AL_FLOOR * ptToDaiPrice) / 1e18
            );
        }
    ...
    function test_lov_PT_sUSDe_Sep24_DAI_shutdown() public {
        ...
        uint256 marketPtToDaiPrice = lovTokenContracts
            .ptSUsdeToDaiOracle
            .latestPrice(
                IMorigamiOracle.PriceType.SPOT_PRICE,
                MorigamiMath.Rounding.ROUND_DOWN
        ...
        params.withdrawCollateralAmount =
            (params.repayAmount * 1e18) /
            marketPtToDaiPrice;
        params.swapData = abi.encode(
            DummyLovTokenSwapper.SwapData(params.withdrawCollateralAmount)
        );
        ...
        assertEq(
            ...
            12_853.547988072612366678e18
        );
    }
}

contract Morigami_lov_PT_sUSDe_Sep24_DAI_IntegrationTest_PegControls is
    Morigami_lov_PT_sUSDe_Sep24_DAI_IntegrationTestBase
{
    function test_lov_PT_sUSDe_Sep24_DAI_rebalanceDown_fail_peg_controls()
        public
    {
    ...
    function test_lov_PT_sUSDe_Sep24_DAI_invest_fail_peg_controls() public {
        ...
        vm.startPrank(alice);
        externalContracts.ptSUSDeToken.approve(
            address(lovTokenContracts.lovToken),
            amount
        );
    ...
    function test_latestPrices() public {
        (
            ...
            address baseAsset,
            address quoteAsset
        ) = lovTokenContracts.ptSUsdeToDaiOracle.latestPrices(
                IMorigamiOracle.PriceType.SPOT_PRICE,
