...
import {Morigami_lov_weETH_wETH_IntegrationTestBase} from "test/foundry/integration/lov-weETH-wETH/Morigami_lov_weETH_wETH_IntegrationTestBase.t.sol";
...
contract Morigami_lov_weETH_wETH_IntegrationTest is
    Morigami_lov_weETH_wETH_IntegrationTestBase
{
    ...
    function test_lov_weETH_wETH_initialization() public {
...

        {
            ...
            assertEq(
                ...
                address(externalContracts.wEthToken)
            );
            assertEq(
            ...
            assertEq(
                ...
                address(lovTokenContracts.weEthToEthOracle)
            );
        }

        {
            assertEq(
                address(lovTokenContracts.weEthToEthOracle.owner()),
                origamiMultisig
            );
            assertEq(
                lovTokenContracts.weEthToEthOracle.description(),
                "weETH/wETH"
            );
            ...
            assertEq(
                address(lovTokenContracts.weEthToEthOracle.spotPriceOracle()),
            ...
            assertEq(
                lovTokenContracts.weEthToEthOracle.spotPricePrecisionScalar(),
                1e10
            ...
            assertEq(
                address(
                    lovTokenContracts.weEthToEthOracle.etherfiLiquidityPool()
                ),
                Constants.ETHERFI_LIQUIDITY_POOL
            );
            assertEq(
                lovTokenContracts.weEthToEthOracle.maxRelativeToleranceBps(),
                30
            );
        }

        {
            ...
            assertEq(
                ...
                hex"698fe98247a40c5771537b5786b2f3f9d78eb487b4ce4d75533cd0e94d88a115"
            );
    ...
    function test_lov_weETH_wETH_invest_success() public {
...

        {
            ...
            assertEq(
                externalContracts.weEthToken.balanceOf(
                    address(lovTokenContracts.lovTokenManager)
                ),
                0
            );
    ...
    function test_lov_weETH_wETH_rebalanceDown_success() public {
        ...
        assertEq(
            lovTokenContracts.weEthToEthOracle.latestPrice(
                IMorigamiOracle.PriceType.SPOT_PRICE,
...

        {
            ...
            assertEq(
                ...
                14.952049703456846935e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.userRedeemableReserves(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
                ),
                15.017505005571458452e18
            );
        }
    }
    ...
    function test_lov_weETH_wETH_rebalanceUp_success() public {
...

        {
            ...
            assertEq(
                lovTokenContracts.lovTokenManager.assetToLiabilityRatio(),
                1.299948134872783277e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.liabilities(
                    IMorigamiOracle.PriceType.SPOT_PRICE
                ),
                49.842154193318714379e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.liabilities(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
                ),
                49.787780305639268916e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.reservesBalance(),
                64.792215381646336716e18
            );
            assertEq(
                lovTokenContracts.borrowLend.suppliedBalance(),
                64.792215381646336716e18
            ...
            assertEq(
                lovTokenContracts.borrowLend.debtBalance(),
                51.603478231888378840e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.userRedeemableReserves(
                    IMorigamiOracle.PriceType.SPOT_PRICE
                ),
                14.950061188327622337e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.userRedeemableReserves(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
                ),
                15.004435076007067800e18
            );

            // No surplus wETH left over
            assertEq(
                externalContracts.wEthToken.balanceOf(
                    address(lovTokenContracts.lovTokenManager)
                ),
                0
            );
    ...
    function test_lov_weETH_wETH_shutdown() public {
        ...
        assertEq(
            ...
            0.755884881648801508e18
        );
    }
}

contract Morigami_lov_weETH_wETH_IntegrationTest_PegControls is
    Morigami_lov_weETH_wETH_IntegrationTestBase
{
    ...
    function test_lov_weETH_wETH_invest_fail_peg_controls() public {
        ...
        vm.startPrank(alice);
        externalContracts.weEthToken.approve(
            address(lovTokenContracts.lovToken),
            amount
        );
    ...
    function test_latestPrices() public {
        (
            ...
            address baseAsset,
            address quoteAsset
        ) = lovTokenContracts.weEthToEthOracle.latestPrices(
                IMorigamiOracle.PriceType.SPOT_PRICE,
