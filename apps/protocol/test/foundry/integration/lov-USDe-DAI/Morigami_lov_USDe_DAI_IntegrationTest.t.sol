...
import {Morigami_lov_USDe_DAI_IntegrationTestBase} from "test/foundry/integration/lov-USDe-DAI/Morigami_lov_USDe_DAI_IntegrationTestBase.t.sol";
import {Morigami_lov_USDe_DAI_TestConstants as Constants} from "test/foundry/deploys/lov-USDe-DAI/Morigami_lov_USDe_DAI_TestConstants.t.sol";
...
contract Morigami_lov_USDe_DAI_IntegrationTest is
    Morigami_lov_USDe_DAI_IntegrationTestBase
{
    ...
    function test_lov_USDe_DAI_initialization() public {
...

        {
            ...
            assertEq(
                ...
                hex"c581c5f70bd1afa283eed57d1418c6432cbff1d862f94eaf58fdd4e46afbb67f"
            );
    ...
    function test_lov_USDe_DAI_invest_success() public {
...

        {
            ...
            assertEq(
                externalContracts.usdeToken.balanceOf(
                    address(lovTokenContracts.lovTokenManager)
                ),
                0
            );
    ...
    function test_lov_USDe_DAI_rebalanceDown_success() public {
        ...
        assertEq(
            lovTokenContracts.usdeToDaiOracle.latestPrice(
                IMorigamiOracle.PriceType.SPOT_PRICE,
...

        {
            ...
            assertEq(
                ...
                49_992.331881466754703842e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.userRedeemableReserves(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
                ),
                49_575.401881466754703842e18
            );
        }
    }
    ...
    function test_lov_USDe_DAI_rebalanceUp_success() public {
...

        {
            ...
            assertEq(
                lovTokenContracts.lovTokenManager.assetToLiabilityRatio(),
                1.299803698780951647e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.liabilities(
                    IMorigamiOracle.PriceType.SPOT_PRICE
                ),
                166_666.273035072026065688e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.liabilities(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
                ),
                167_013.713881154588964825e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.reservesBalance(),
                216_633.438153022603716646e18
            );
            assertEq(
                lovTokenContracts.borrowLend.suppliedBalance(),
                216_633.438153022603716646e18
            ...
            assertEq(
                ...
                49_967.165117950577650958e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.userRedeemableReserves(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
                ),
                49_619.724271868014751821e18
            );
    ...
    function test_lov_USDe_DAI_shutdown() public {
        ...
        assertEq(
            ...
            686.906447832894814758e18
        );
    }
}

contract Morigami_lov_USDe_DAI_IntegrationTest_PegControls is
    Morigami_lov_USDe_DAI_IntegrationTestBase
{
    ...
    function test_lov_USDe_DAI_invest_fail_peg_controls() public {
        ...
        vm.startPrank(alice);
        externalContracts.usdeToken.approve(
            address(lovTokenContracts.lovToken),
            amount
        );
    ...
    function test_latestPrices() public {
        (
            ...
            address baseAsset,
            address quoteAsset
        ) = lovTokenContracts.usdeToDaiOracle.latestPrices(
                IMorigamiOracle.PriceType.SPOT_PRICE,
