...
import {Morigami_lov_wETH_sDAI_2xShort_IntegrationTestBase} from "test/foundry/integration/lov-wETH-sDAI-2xShort-spark/Morigami_lov_wETH_sDAI_2xShort_IntegrationTestBase.t.sol";
import {Morigami_lovToken_TestConstants as Constants} from "test/foundry/deploys/lov-wETH-sDAI-2xShort-spark/Morigami_lovToken_TestConstants.t.sol";
...
contract Morigami_lov_wETH_sDAI_2xShort_IntegrationTest is
    Morigami_lov_wETH_sDAI_2xShort_IntegrationTestBase
{
    ...
    function test_lovToken_rebalanceDown_success() public {
        ...
        assertEq(
            (reservesAmount * 1e8) / params.flashLoanAmount,
            expectedSwapPrice
        );
...

        {
            ...
            assertEq(
                lovTokenContracts.lovTokenManager.assetToLiabilityRatio(),
                2.000000000000000033e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.liabilities(
                    IMorigamiOracle.PriceType.SPOT_PRICE
                ),
                49.999999999999999175e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.liabilities(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
    ...
    function test_lovToken_rebalanceUp_success() public {
...

        {
            ...
            assertEq(
                lovTokenContracts.lovTokenManager.assetToLiabilityRatio(),
                2.099999999999999945e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.liabilities(
                    IMorigamiOracle.PriceType.SPOT_PRICE
                ),
                45.454545454545456475e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.liabilities(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
            ...
            assertEq(
                lovTokenContracts.borrowLend.debtBalance(),
                0.015423590554743300e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.userRedeemableReserves(
                    IMorigamiOracle.PriceType.SPOT_PRICE
                ),
                49.999999999999999645e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.userRedeemableReserves(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
    ...
    function test_lovToken_shutdown() public {
        ...
        assertEq(
            ...
            0.000093194640976742e18
        );
    }
}

contract Morigami_lov_wETH_sDAI_2xShort_IntegrationTest_PegControls is
    Morigami_lov_wETH_sDAI_2xShort_IntegrationTestBase
{
