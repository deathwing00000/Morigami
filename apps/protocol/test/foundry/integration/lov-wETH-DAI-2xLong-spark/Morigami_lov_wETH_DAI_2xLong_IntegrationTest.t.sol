...
import {Morigami_lov_wETH_DAI_2xLong_IntegrationTestBase} from "test/foundry/integration/lov-wETH-DAI-2xLong-spark/Morigami_lov_wETH_DAI_2xLong_IntegrationTestBase.t.sol";
...
contract Morigami_lov_wETH_DAI_2xLong_IntegrationTest is
    Morigami_lov_wETH_DAI_2xLong_IntegrationTestBase
{
    ...
    function test_lovToken_rebalanceUp_success() public {
...

        {
            ...
            assertEq(
                lovTokenContracts.lovTokenManager.assetToLiabilityRatio(),
                2.099892356627592551e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.liabilities(
                    IMorigamiOracle.PriceType.SPOT_PRICE
                ),
                45.387568853157904692e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.liabilities(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
            ...
            assertEq(
                lovTokenContracts.borrowLend.debtBalance(),
                133_760.767584219235167508e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.userRedeemableReserves(
                    IMorigamiOracle.PriceType.SPOT_PRICE
                ),
                49.921440067496965959e18
            );
            assertEq(
                lovTokenContracts.lovTokenManager.userRedeemableReserves(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
    ...
    function test_lovToken_shutdown() public {
        ...
        assertEq(
            ...
            432.182566167657665931e18
        );
    }
}

contract Morigami_lov_wETH_DAI_2xLong_IntegrationTest_PegControls is
    Morigami_lov_wETH_DAI_2xLong_IntegrationTestBase
{
