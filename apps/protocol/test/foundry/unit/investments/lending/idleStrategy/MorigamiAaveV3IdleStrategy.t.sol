...
contract MorigamiAaveV3IdleStrategyTest is MorigamiTest {
    ...
    MorigamiAaveV3IdleStrategy public idleStrategy;
    ...
    function maxBorrow() internal {
        ...
        IPool lendingPool = IPool(
            IPoolAddressesProvider(poolAddressProvider).getPool()
        );
        ...
        uint256 idleUsdc = IERC20(usdcToken).balanceOf(
            address(idleStrategy.aToken())
        );
    ...
    function test_initialization() public {
        ...
        assertEq(
            address(idleStrategy.lendingPool()),
    ...
    function test_allocate_success() public {
        ...
        assertEq(
            idleStrategy.aToken().balanceOf(address(idleStrategy)),
            amount
        );
