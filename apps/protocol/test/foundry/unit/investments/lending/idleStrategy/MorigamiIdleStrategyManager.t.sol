...
import {MorigamiIdleStrategyTestBase} from "./MorigamiIdleStrategyTestBase.t.sol";
import {CommonEventsAndErrors} from "contracts/libraries/CommonEventsAndErrors.sol";

contract MorigamiIdleStrategyManagerTestAdmin is MorigamiIdleStrategyTestBase {
    ...
    function test_setIdleStrategy() public {
        ...
        assertEq(
            asset.allowance(address(manager), address(idleStrategy)),
            type(uint256).max
        );
...
contract MorigamiIdleStrategyManagerTestAccess is MorigamiIdleStrategyTestBase {
...
contract MorigamiIdleStrategyManagerTestAllocate is
    MorigamiIdleStrategyTestBase
{
    event Allocated(uint256 amount, uint256 idleStrategyAmount);
    event Withdrawn(
        address indexed recipient,
        uint256 amount,
        uint256 idleStrategyAmount
    );
    ...
    function test_withdraw_withIdleStrategy_partialIdleStrategyBalance_notEnough()
        public
    {
        vm.startPrank(origamiMultisig);
    ...
    function test_withdraw_withIdleStrategy_allIdleStrategyBalance_zeroBuffer()
        public
    {
        vm.startPrank(origamiMultisig);
        // All allocated to idle
    ...
    function test_withdraw_withIdleStrategy_partialIdleStrategyBalance_zeroBuffer()
        public
    {
        vm.startPrank(origamiMultisig);
    ...
    function test_withdraw_withIdleStrategy_partialIdleStrategyBalance_withBuffer_hitMaxAvailable()
        public
    {
        vm.startPrank(origamiMultisig);
    ...
    function test_withdraw_withIdleStrategy_partialIdleStrategyBalance_withBuffer_overMaxAvailable()
        public
    {
        vm.startPrank(origamiMultisig);
        addThresholds(25e18, 10e18);
