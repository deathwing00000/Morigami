...
contract MorigamiLovTokenTestBase is MorigamiTest {
    ...
    function setUp() public virtual {
        ...
        tokenPrices.setTokenPriceFunction(
            address(sDaiToken),
            abi.encodeCall(TokenPrices.erc4626TokenPrice, (address(sDaiToken)))
        );
        tokenPrices.setTokenPriceFunction(
            address(lovToken),
    ...
    function investWithDai(
        ...
        (IMorigamiInvestment.InvestQuoteData memory quoteData, ) = lovToken
            .investQuote(daiAmount, address(daiToken), 0, 0);
    ...
    function solveRebalanceDownAmount(
        ...
        */
        ...
        uint256 _precision = IMorigamiLovTokenManager(_manager).PRECISION();
