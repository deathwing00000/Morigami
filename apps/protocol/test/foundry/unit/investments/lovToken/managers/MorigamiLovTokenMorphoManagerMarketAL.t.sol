...
import {MorigamiLovTokenMorphoManagerTestBase, MorigamiLovTokenMorphoManagerTestAdmin, MorigamiLovTokenMorphoManagerTestAccess, MorigamiLovTokenMorphoManagerTestViews, MorigamiLovTokenMorphoManagerTestInvest, MorigamiLovTokenMorphoManagerTestExit, MorigamiLovTokenMorphoManagerTestRebalanceDown, MorigamiLovTokenMorphoManagerTestRebalanceUp} from "./MorigamiLovTokenMorphoManager.t.sol";
import {DummyOracle} from "contracts/test/common/DummyOracle.sol";
import {IMorigamiOracle} from "contracts/interfaces/common/oracle/IMorigamiOracle.sol";
...
contract MorigamiLovTokenMorphoManagerMarketALTestBase is
    MorigamiLovTokenMorphoManagerTestBase
{
    using MorigamiMath for uint256;

    DummyOracle internal fixedPriceOracle;
    MorigamiVolatileChainlinkOracle internal morphoALToMarketALOracle;

    MorigamiLovTokenMorphoManagerMarketAL internal alManager;
    ...
    function setUp() public virtual override {
        ...
        fixedPriceOracle = new DummyOracle(
            DummyOracle.Answer(0, int128(ORACLE_PRICE), 0, 0, 0),
            18
        );

        morphoALToMarketALOracle = new MorigamiVolatileChainlinkOracle(
        ...
        alManager = new MorigamiLovTokenMorphoManagerMarketAL(
            origamiMultisig,
            address(sUsdeToken),
            address(daiToken),
            address(usdeToken),
    ...
    function convertAL(
        uint128 al
    ) internal view virtual override returns (uint128) {
        return
            uint128(
                uint256(al).mulDiv(
                    1e18,
...
contract MorigamiLovTokenMorphoManagerMarketALTestAdmin is
    MorigamiLovTokenMorphoManagerMarketALTestBase,
    MorigamiLovTokenMorphoManagerTestAdmin
{
    ...
    function test_initialization() public override {
        super.test_initialization();

        assertEq(
            alManager.morphoALToMarketALOracle(),
            address(morphoALToMarketALOracle)
        );
    }
...
contract MorigamiLovTokenMorphoManagerMarketALTestAccess is
    MorigamiLovTokenMorphoManagerMarketALTestBase,
    MorigamiLovTokenMorphoManagerTestAccess
{
    function setUp()
        public
        override(
...
contract MorigamiLovTokenMorphoManagerMarketALTestViews is
    MorigamiLovTokenMorphoManagerMarketALTestBase,
    MorigamiLovTokenMorphoManagerTestViews
{
    function setUp()
        public
        override(
    ...
    function test_liabilities_success() public override {
        ...
        assertEq(
            manager.liabilities(IMorigamiOracle.PriceType.SPOT_PRICE),
            149.999999999700000397e18
        );
        assertEq(
            manager.liabilities(IMorigamiOracle.PriceType.HISTORIC_PRICE),
            150.438296999699123754e18
        );
    ...
    function test_as_price_changes() public {
        ...
        // Before a price update
        {
            ...
            assertEq(
                manager.effectiveExposure(
                    IMorigamiOracle.PriceType.HISTORIC_PRICE
                ),
                5.059130715067248792e18
            );
        }
...
contract MorigamiLovTokenMorphoManagerMarketALTestInvest is
    MorigamiLovTokenMorphoManagerMarketALTestBase,
    MorigamiLovTokenMorphoManagerTestInvest
{
    function setUp()
        public
        override(
...
contract MorigamiLovTokenMorphoManagerMarketALTestExit is
    MorigamiLovTokenMorphoManagerMarketALTestBase,
    MorigamiLovTokenMorphoManagerTestExit
{
    function setUp()
        public
        override(
...
contract MorigamiLovTokenMorphoManagerMarketALTestRebalanceDown is
    MorigamiLovTokenMorphoManagerMarketALTestBase,
    MorigamiLovTokenMorphoManagerTestRebalanceDown
{
    function setUp()
        public
        override(
    ...
    function test_rebalanceDown_success_al_floor_force() public override {
        ...
        manager.setRebalanceALRange(
            convertAL(uint128(targetAL + 0.01e18)),
...
contract MorigamiLovTokenMorphoManagerMarketALTestRebalanceUp is
    MorigamiLovTokenMorphoManagerMarketALTestBase,
    MorigamiLovTokenMorphoManagerTestRebalanceUp
{
    function setUp()
        public
        override(
