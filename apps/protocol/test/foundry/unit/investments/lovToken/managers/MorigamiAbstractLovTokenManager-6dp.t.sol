...
import {MorigamiLovTokenTestBase_6dp} from "test/foundry/unit/investments/lovToken/MorigamiLovTokenBase-6dp.t.sol";
...
contract MorigamiAbstractLovTokenManagerTestAdmin_6dp is
    MorigamiLovTokenTestBase_6dp
{
    event FeeConfigSet(
...
contract MorigamiAbstractLovTokenManagerTestAccess_6dp is
    MorigamiLovTokenTestBase_6dp
{
...
contract MorigamiAbstractLovTokenManagerTestViews_6dp is
    MorigamiLovTokenTestBase_6dp
{
    ...
    function test_reservesToShares() public {
        // No supply
        assertEq(
            manager.reservesToShares(5e6, IMorigamiOracle.PriceType.SPOT_PRICE),
            5e18
        );
        assertEq(
...
contract MorigamiAbstractLovTokenManagerTestInvest_6dp is
    MorigamiLovTokenTestBase_6dp
{
    using MorigamiMath for uint256;
    ...
    function test_maxInvest() public {
        ...
        uint256 expectedFreeAssets = expectedFreeShares.mulDiv(
            sUsdcToken.totalAssets(),
            sUsdcToken.totalSupply(),
    ...
    function test_investWithToken_failPaused() public {
        ...
        (IMorigamiInvestment.InvestQuoteData memory quoteData, ) = manager
            .investQuote(100, address(sUsdcToken), 100, 123);
        vm.startPrank(address(lovToken));
        vm.expectRevert(
    ...
    function test_investWithToken_fail_zero() public {
        ...
        (IMorigamiInvestment.InvestQuoteData memory quoteData, ) = manager
            .investQuote(100, address(usdcToken), slippageBps, 123);
    ...
    function test_investWithToken_fail_slippage() public {
        ...
        (IMorigamiInvestment.InvestQuoteData memory quoteData, ) = manager
            .investQuote(depositAmount, address(usdcToken), slippageBps, 123);
    ...
    function test_investWithToken_success_depositToken() public {
        ...
        assertEq(
            sUsdcToken.balanceOf(address(manager)),
...
contract MorigamiAbstractLovTokenManagerTestExit_6dp is
    MorigamiLovTokenTestBase_6dp
{
    using MorigamiMath for uint256;
    ...
    function test_maxExit() public {
        ...
        assertEq(
            manager.maxExit(address(usdcToken)),
            582.411789473684210526e18
        );
    ...
    function test_exitQuote_fail_zero() public {
        ...
        manager.exitQuote(exitAmount, address(usdcToken), slippageBps, 123);
    }
    ...
    function test_exitToToken_fail_paused() public {
        ...
        (IMorigamiInvestment.ExitQuoteData memory quoteData, ) = manager
            .exitQuote(exitAmount, address(sUsdcToken), slippageBps, 123);
        vm.startPrank(address(lovToken));
        vm.expectRevert(
            abi.encodeWithSelector(CommonEventsAndErrors.IsPaused.selector)
        );
    ...
    function test_exitToToken_success_depositToken() public {
        ...
        uint256 exitAmount = 15e18;
        (IMorigamiInvestment.ExitQuoteData memory quoteData, ) = manager
            .exitQuote(exitAmount, address(usdcToken), slippageBps, 123);
        ...
        uint256 expectedUsdcAmount = sUsdcToken.previewRedeem(
            expectedSUsdcAmount
        );
        ...
        assertEq(
            manager.reservesBalance(),
            100e6 + (900e6 + 1) - expectedSUsdcAmount
        );
        assertEq(
            sUsdcToken.balanceOf(address(manager)),
            manager.reservesBalance()
