...
import {IMorigamiLovTokenMorphoManager} from "contracts/interfaces/investments/lovToken/managers/IMorigamiLovTokenMorphoManager.sol";
...
contract MorigamiLovTokenMorphoManagerTestBase is MorigamiTest {
    ...
    MorigamiLovTokenMorphoManager internal manager;
    TokenPrices internal tokenPrices;
    DummyLovTokenSwapper internal swapper;
    MorigamiMorphoBorrowAndLend internal borrowLend;
    ...
    uint128 internal constant USDE_USD_STALENESS_THRESHOLD =
    ...
    function setUp() public virtual {
        ...
        manager = new MorigamiLovTokenMorphoManager(
            origamiMultisig,
            address(sUsdeToken),
            address(daiToken),
            address(usdeToken),
    ...
    function convertAL(uint128 al) internal view virtual returns (uint128) {
        return al;
    }
    ...
    function investLovToken(
        ...
        (IMorigamiInvestment.InvestQuoteData memory quoteData, ) = lovToken
            .investQuote(amount, address(sUsdeToken), 0, 0);

        amountOut = lovToken.investWithToken(quoteData);
    }

    function exitLovToken(
        address account,
        uint256 amount,
        address recipient
    ) internal returns (uint256 amountOut) {
        ...
        (IMorigamiInvestment.ExitQuoteData memory quoteData, ) = lovToken
            .exitQuote(amount, address(sUsdeToken), 0, 0);
    ...
    function doRebalanceDown(
        ...
        IMorigamiLovTokenMorphoManager.RebalanceDownParams memory params;
        ...
        )
    {
        ...
        params.supplyAmount = reservesAmount.subtractBps(
            swapSlippageBps,
            MorigamiMath.Rounding.ROUND_DOWN
        );
    ...
    function doRebalanceUp(
        ...
        IMorigamiLovTokenMorphoManager.RebalanceUpParams
    ...
    function rebalanceUpParams(
        ...
        view
        virtual
        returns (IMorigamiLovTokenMorphoManager.RebalanceUpParams memory params)
    {
        // ideal reserves amount to remove
        params.withdrawCollateralAmount = LovTokenHelpers
            .solveRebalanceUpAmount(manager, targetAL);
        ...
        params.swapData = abi.encode(
            DummyLovTokenSwapper.SwapData({buyTokenAmount: params.repayAmount})
        );
        ...
        params.repayAmount = params.repayAmount.subtractBps(
            swapSlippageBps,
            MorigamiMath.Rounding.ROUND_DOWN
        );
...
contract MorigamiLovTokenMorphoManagerTestAdmin is
    MorigamiLovTokenMorphoManagerTestBase
{
    event OraclesSet(
    ...
    function test_setOracleConfig_fail() public virtual {
        ...
        MorigamiErc4626Oracle badOracle = new MorigamiErc4626Oracle(
            IMorigamiOracle.BaseOracleParams(
                "sUSDE/alice",
                address(sUsdeToken),
                18,
        ...
        badOracle = new MorigamiErc4626Oracle(
            IMorigamiOracle.BaseOracleParams(
                "alice/DAI",
                alice,
                18,
    ...
    function test_setOracles() public virtual {
        ...
        MorigamiErc4626Oracle oracle1 = new MorigamiErc4626Oracle(
            IMorigamiOracle.BaseOracleParams(
                "sUSDE/ETH",
                address(sUsdeToken),
                18,
        ...
        MorigamiErc4626Oracle oracle2 = new MorigamiErc4626Oracle(
            IMorigamiOracle.BaseOracleParams(
                "stETH/ETH",
                address(usdeToken),
                18,
...
contract MorigamiLovTokenMorphoManagerTestAccess is
    MorigamiLovTokenMorphoManagerTestBase
{
    ...
    function test_access_rebalanceDown() public virtual {
        ...
        manager.rebalanceDown(
            IMorigamiLovTokenMorphoManager.RebalanceDownParams(
                0,
                0,
                bytes(""),
                0,
...
contract MorigamiLovTokenMorphoManagerTestViews is
    MorigamiLovTokenMorphoManagerTestBase
{
    ...
    function test_liabilities_success() public virtual {
        ...
        assertEq(
            manager.liabilities(IMorigamiOracle.PriceType.HISTORIC_PRICE),
            200.584395999999999935e18
        );

        doRebalanceUp(rebalanceALRange.ceiling, 0, 5);
        assertEq(
            manager.liabilities(IMorigamiOracle.PriceType.SPOT_PRICE),
            149.999999999699999947e18
        );
        assertEq(
            manager.liabilities(IMorigamiOracle.PriceType.HISTORIC_PRICE),
            150.438296999699123303e18
        );
    ...
    function test_liabilities_withDebt_notPricingToken() public virtual {
...

        {
            ...
            MorigamiCrossRateOracle daiToSUsde = new MorigamiCrossRateOracle(
                IMorigamiOracle.BaseOracleParams(
                    "DAI/sUSDe",
                    address(daiToken),
                    18,
        ...
        assertEq(
            manager.liabilities(IMorigamiOracle.PriceType.SPOT_PRICE),
            200.000000000000000013e18
        );
        assertEq(
            manager.liabilities(IMorigamiOracle.PriceType.HISTORIC_PRICE),
            200.584395999999999960e18
        );
    }
...
contract MorigamiLovTokenMorphoManagerTestInvest is
    MorigamiLovTokenMorphoManagerTestBase
{
    using MorigamiMath for uint256;
    ...
    function test_maxInvest_reserveToken() public virtual {
...

        {
            ...
            (IMorigamiInvestment.InvestQuoteData memory quoteData, ) = lovToken
                .investQuote(investAmount, address(sUsdeToken), 0, 0);

            vm.expectRevert(
                abi.encodeWithSelector(
                    IMorigamiLovTokenManager.ALTooHigh.selector,
                    1.25e18,
                    1.428571428571430002e18,
                    1.428571428571430000e18
                )
            );
    ...
    function test_maxInvest_reserveToken_withMaxTotalSupply() public virtual {
        ...
        (, uint256 expectedAvailable) = borrowLend.availableToSupply();
        {
            ...
            // share price = 1, +fees
            assertEq(
                manager.maxInvest(address(sUsdeToken)),
                210_526.315789473684210526e18
            );
        }
    ...
    function test_investQuote_reserveToken() public virtual {
        (
            IMorigamiInvestment.InvestQuoteData memory quoteData,
            uint256[] memory investFeeBps
        ) = manager.investQuote(1e18, address(sUsdeToken), 100, 123);
    ...
    function test_investWithToken_fail_badToken() public virtual {
        ...
        (IMorigamiInvestment.InvestQuoteData memory quoteData, ) = manager
            .investQuote(amount, address(sUsdeToken), 100, 123);
...
contract MorigamiLovTokenMorphoManagerTestExit is
    MorigamiLovTokenMorphoManagerTestBase
{
    using MorigamiMath for uint256;
    ...
    function test_maxExit_reserveToken() public virtual {
        ...
        // Rebalance down properly
        {
            ...
            assertEq(
                manager.liabilities(IMorigamiOracle.PriceType.HISTORIC_PRICE),
                40_116.879199999999986604e18
            );
            assertEq(
                manager.maxExit(address(sUsdeToken)),
                4_511.278195488842105262e18
            );
        }
        ...
        {
            assertEq(
                borrowLend.availableToBorrow(),
                9_979_248.978174019999743496e18
            );
            assertEq(
                borrowLend.availableToWithdraw(),
                29_999.999999999999999996e18
            );
    ...
    function test_exitQuote_reserveToken() public virtual {
        (
            IMorigamiInvestment.ExitQuoteData memory quoteData,
            uint256[] memory exitFeeBps
        ) = manager.exitQuote(1e18, address(sUsdeToken), 100, 123);
    ...
    function test_exitToToken_fail_badToken() public virtual {
        (IMorigamiInvestment.ExitQuoteData memory quoteData, ) = manager
            .exitQuote(1e18, address(sUsdeToken), 100, 123);
    ...
    function test_exitToToken_success() public virtual {
        ...
        (IMorigamiInvestment.ExitQuoteData memory quoteData, ) = manager
            .exitQuote(shares, address(sUsdeToken), 100, 123);
...
contract MorigamiLovTokenMorphoManagerTestRebalanceDown is
    MorigamiLovTokenMorphoManagerTestBase
{
    using MorigamiMath for uint256;
    ...
    function test_rebalanceDown_fail_slippage() public virtual {
        ...
        params.swapData = abi.encode(
            DummyLovTokenSwapper.SwapData({buyTokenAmount: params.borrowAmount})
        );
    ...
    function test_rebalanceDown_success_noSupply() public virtual {
        ...
        params.borrowAmount = 10e18;
        params.swapData = abi.encode(
            DummyLovTokenSwapper.SwapData({buyTokenAmount: params.supplyAmount})
        );
    ...
    function test_rebalanceDown_fail_al_validation() public virtual {
        ...
        // Meaning we have more reserves, so A/L is higher than we started out.
        {
            ...
            deal(
                address(sUsdeToken),
                address(swapper),
                (reservesAmount * 1.3e18) / 1e18
            );
            vm.expectRevert(
                abi.encodeWithSelector(
                    IMorigamiLovTokenManager.ALTooHigh.selector,
                    1.250199999999999999e18,
                    1.250239808153477218e18,
                    1.250199999999999999e18
                )
            );
            manager.rebalanceDown(params);
    ...
    function test_rebalanceDown_fail_al_floor() public virtual {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IMorigamiLovTokenManager.ALTooLow.selector,
                type(uint128).max,
                1.176470588235289999e18,
                1.176470588235290000e18
            )
        );
        manager.rebalanceDown(params);
    }
    ...
    function test_rebalanceDown_success_withEvent() public virtual {
        ...
        assertEq(
            manager.liabilities(IMorigamiOracle.PriceType.SPOT_PRICE),
            expectedCollateralAdded + 1
        );
        assertEq(
            manager.liabilities(IMorigamiOracle.PriceType.HISTORIC_PRICE),
            200_584.395999999999933060e18
        );
    ...
    function test_rebalanceDown_success_surplus_underThreshold()
        public
        virtual
    {
        uint256 amount = 50_000e18;
        ...
        assertEq(
            ...
            amount + expectedCollateralAdded - 400e18
        );
        assertEq(
            manager.liabilities(IMorigamiOracle.PriceType.SPOT_PRICE),
            expectedCollateralAdded + 1
...
contract MorigamiLovTokenMorphoManagerTestRebalanceUp is
    MorigamiLovTokenMorphoManagerTestBase
{
    using MorigamiMath for uint256;
    ...
    function test_rebalanceUp_fail_noDebt() public virtual {
        IMorigamiLovTokenMorphoManager.RebalanceUpParams
            memory params = IMorigamiLovTokenMorphoManager.RebalanceUpParams({
                repayAmount: 10e18,
    ...
    function test_rebalanceUp_success_forceRepayTooMuch_noSurplus()
        public
        virtual
    {
        uint256 amount = 50_000e18;
        ...
        IMorigamiLovTokenMorphoManager.RebalanceUpParams memory params;
        {
        ...
        assertEq(sUsdeToken.balanceOf(address(borrowLend)), 0);
        assertEq(
            daiToken.balanceOf(address(borrowLend)),
            51.877557070436584149e18
        );
    }

    function test_rebalanceUp_success_forceRepayTooMuch_withSurplus()
        public
        virtual
    {
        uint256 amount = 50_000e18;
        ...
        assertEq(
            manager.liabilities(IMorigamiOracle.PriceType.SPOT_PRICE),
            0.999999999999807241e18
        );
        assertEq(
            manager.liabilities(IMorigamiOracle.PriceType.HISTORIC_PRICE),
            1.002921979999806677e18
        );
    ...
    function test_rebalanceUp_fail_al_validation() public virtual {
        ...
        // Meaning we withdraw more collateral, so A/L is higher than we started out.
        {
            ...
            params.withdrawCollateralAmount =
                (params.withdrawCollateralAmount * 1.3e18) /
                1e18;
            vm.expectRevert(
                abi.encodeWithSelector(
                    IMorigamiLovTokenManager.ALTooLow.selector,
    ...
    function test_rebalanceUp_success_withEvent() public virtual {
        ...
        assertEq(
            manager.liabilities(IMorigamiOracle.PriceType.SPOT_PRICE),
            166_666.666666666666634534e18
        );
        assertEq(
            manager.liabilities(IMorigamiOracle.PriceType.HISTORIC_PRICE),
            167_153.663333333333245322e18
        );
    ...
    function test_rebalanceUp_success_surplusUnderThreshold() public virtual {
        ...
        assertEq(
            manager.liabilities(IMorigamiOracle.PriceType.SPOT_PRICE),
            166_733.333333333333301265e18
        );
        assertEq(
            manager.liabilities(IMorigamiOracle.PriceType.HISTORIC_PRICE),
            167_220.524798666666578698e18
        );
