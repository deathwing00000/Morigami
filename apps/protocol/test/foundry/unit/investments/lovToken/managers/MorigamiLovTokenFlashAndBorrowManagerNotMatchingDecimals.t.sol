...
contract MorigamiLovTokenFlashAndBorrowManagerNotMatchingDecimalsTestBase is
    MorigamiTest
{
    ...
    MorigamiVolatileChainlinkOracle wEthToWbtcOracle;
    ...
    address internal constant CL_ETH_BTC_ORACLE =
        0xAc559F25B1619171CbC396a50854A3240b6A4e99;
    address internal constant SPARK_A_WETH_ADDRESS =
        0x59cD1C87501baa753d0B5B5Ab5D8416A45cD71DB;
    address internal constant SPARK_D_WBTC_ADDRESS =
    ...
    function setUp() public {
        ...
        // Oracles
        {
            ...
            wEthToWbtcOracle = new MorigamiVolatileChainlinkOracle(
    ...
    function investLovToken(
        ...
        (IMorigamiInvestment.InvestQuoteData memory quoteData, ) = lovToken
            .investQuote(amount, address(wethToken), 0, 0);
    ...
    function exitLovToken(
        ...
        (IMorigamiInvestment.ExitQuoteData memory quoteData, ) = lovToken
            .exitQuote(amount, address(wethToken), 0, 0);
...
contract MorigamiLovTokenFlashAndBorrowManagerNotMatchingDecimalsTestAdmin is
    MorigamiLovTokenFlashAndBorrowManagerNotMatchingDecimalsTestBase
{
    event OraclesSet(
    ...
    function test_setSwapper_success() public {
        ...
        assertEq(
            wbtcToken.allowance(address(manager), alice),
            type(uint256).max
        );
...
contract MorigamiLovTokenFlashAndBorrowManagerNotMatchingDecimalsTestAccess is
    MorigamiLovTokenFlashAndBorrowManagerNotMatchingDecimalsTestBase
{
...
contract MorigamiLovTokenFlashAndBorrowManagerNotMatchingDecimalsTestViews is
    MorigamiLovTokenFlashAndBorrowManagerNotMatchingDecimalsTestBase
{
    function test_reservesBalance() public {
        ...
        assertEq(
            ...
            IERC20(SPARK_A_WETH_ADDRESS).balanceOf(address(borrowLend))
        );
    ...
    function test_liabilities_success() public {
        ...
        investLovToken(alice, amount);
        assertEq(
            IERC20(SPARK_D_WBTC_ADDRESS).balanceOf(address(borrowLend)),
            0
        );
        assertEq(manager.liabilities(IMorigamiOracle.PriceType.SPOT_PRICE), 0);
        assertEq(
    ...
    function test_liabilities_withDebt_notPricingToken() public {
...

        {
            ...
            MorigamiVolatileChainlinkOracle oOne = new MorigamiVolatileChainlinkOracle(
                    IMorigamiOracle.BaseOracleParams(
                        "ONE/ONE",
                        address(wbtcToken),
                        18,
            ...
            MorigamiCrossRateOracle btcToEth = new MorigamiCrossRateOracle(
                IMorigamiOracle.BaseOracleParams(
                    "wBTC/wETH",
                    address(wbtcToken),
                    8,
...
contract MorigamiLovTokenFlashAndBorrowManagerNotMatchingDecimalsTestInvest is
    MorigamiLovTokenFlashAndBorrowManagerNotMatchingDecimalsTestBase
{
    using MorigamiMath for uint256;
    ...
    function test_availableSupply() public {
        (uint256 supplyCap, uint256 expectedAvailable) = borrowLend
            .availableToSupply();
    ...
    function test_maxInvest_reserveToken() public {
...

        {
            ...
            (IMorigamiInvestment.InvestQuoteData memory quoteData, ) = lovToken
                .investQuote(investAmount, address(wethToken), 0, 0);

            vm.expectRevert(
                abi.encodeWithSelector(
                    IMorigamiLovTokenManager.ALTooHigh.selector,
                    1.750000024039043032e18,
                    1.900000000000000007e18,
                    1.9e18
                )
            );
        ...
        assertEq(
            manager.maxInvest(address(wethToken)),
            1.915966050602167855e18
        );
    }
    ...
    function test_investQuote_reserveToken() public {
        (
            IMorigamiInvestment.InvestQuoteData memory quoteData,
            uint256[] memory investFeeBps
        ) = manager.investQuote(1e18, address(wethToken), 100, 123);
    ...
    function test_investWithToken_fail_badToken() public {
        ...
        (IMorigamiInvestment.InvestQuoteData memory quoteData, ) = manager
            .investQuote(amount, address(wethToken), 100, 123);
...
contract MorigamiLovTokenFlashAndBorrowManagerNotMatchingDecimalsTestExit is
    MorigamiLovTokenFlashAndBorrowManagerNotMatchingDecimalsTestBase
{
    using MorigamiMath for uint256;
    ...
    function test_maxExit_reserveToken() public {
        ...
        // Only rebalance a little. A/L is still 11. Still capped at total supply (10e18)
        {
            ...
            assertEq(
                manager.maxExit(address(wethToken)),
                9.999999999999999998e18
            );
        }
    ...
    function test_exitQuote_reserveToken() public {
        (
            IMorigamiInvestment.ExitQuoteData memory quoteData,
            uint256[] memory exitFeeBps
        ) = manager.exitQuote(1e18, address(wethToken), 100, 123);
    ...
    function test_exitToToken_fail_badToken() public {
        (IMorigamiInvestment.ExitQuoteData memory quoteData, ) = manager
            .exitQuote(1e18, address(wethToken), 100, 123);
    ...
    function test_exitToToken_success() public {
        ...
        (IMorigamiInvestment.ExitQuoteData memory quoteData, ) = manager
            .exitQuote(shares, address(wethToken), 100, 123);
...
contract MorigamiLovTokenFlashAndBorrowManagerNotMatchingDecimalsTestRebalanceDown is
    MorigamiLovTokenFlashAndBorrowManagerNotMatchingDecimalsTestBase
{
    using MorigamiMath for uint256;
    ...
    function test_rebalanceDown_fail_al_validation() public {
        ...
        // Meaning we have more reserves, so A/L is higher than we started out.
        {
            ...
            vm.expectRevert(
                abi.encodeWithSelector(
                    IMorigamiLovTokenManager.ALTooHigh.selector,
                    1.750200002678575969e18,
                    1.766915493550074183e18,
                    1.734e18
                )
            );
            manager.rebalanceDown(params);
...
contract MorigamiLovTokenFlashAndBorrowManagerNotMatchingDecimalsTestRebalanceUp is
    MorigamiLovTokenFlashAndBorrowManagerNotMatchingDecimalsTestBase
{
    using MorigamiMath for uint256;
        ...
        IMorigamiLovTokenFlashAndBorrowManager.RebalanceUpParams
            memory params = IMorigamiLovTokenFlashAndBorrowManager
                .RebalanceUpParams({
                    ...
                    swapData: abi.encode(
                        DummyLovTokenSwapper.SwapData({buyTokenAmount: 10e8})
                    ),
    ...
    function test_rebalanceUp_success_forceRepayTooMuch_noSurplus() public {
        ...
        uint256 currentDebt = IERC20(SPARK_D_WBTC_ADDRESS).balanceOf(
            address(borrowLend)
        );
        assertEq(
            IERC20(SPARK_A_WETH_ADDRESS).balanceOf(address(borrowLend)),
