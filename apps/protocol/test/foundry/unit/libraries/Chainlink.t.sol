...
contract ChainlinkTest is MorigamiTest {
    ...
    function test_scalingFactor() public {
        (uint128 scalar, bool scaleDown) = chainlinkMock.scalingFactor(
            oracle,
            18
        );
    ...
    function test_price_failStaleRound_withValidation() public {
        ...
        Chainlink.Config memory config = Chainlink.Config(
            oracle,
            scaleDown,
            scalar,
            1 days,
        ...
        chainlinkMock.price(config, MorigamiMath.Rounding.ROUND_DOWN);
    }
    ...
    function test_price_scaleDown() public {
        ...
        assertEq(
            chainlinkMock.price(config, MorigamiMath.Rounding.ROUND_UP),
            123.45679e6
        );
    }
