...
contract MockClient is IMorigamiFlashLoanProvider, IMorigamiFlashLoanReceiver {
    ...
    MorigamiAaveV3FlashLoanProvider public flProvider;
    uint256 public transientBalance;
    bytes public transientParams;

    constructor(MorigamiAaveV3FlashLoanProvider _flProvider) {
...
contract MockClientBad is MockClient {
    constructor(
        MorigamiAaveV3FlashLoanProvider _flProvider
...
contract MorigamiAaveV3FlashLoanProviderTestBase is MorigamiTest {
    MorigamiAaveV3FlashLoanProvider public flProvider;
    IERC20 public wethToken;
    MockClient public mockClient;

    address public constant SPARK_POOL_ADDRESS_PROVIDER =
