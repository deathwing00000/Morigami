...
contract MorigamiMorphoBorrowAndLend_6dp_TestBase is MorigamiTest {
    ...
    address internal constant MORPHO_MARKET_ORACLE =
        0xE47E36457D0cF83A74AE1e45382B7A044f7abd99;
...
contract MorigamiMorphoBorrowAndLend_6dp_TestAdmin is
    MorigamiMorphoBorrowAndLend_6dp_TestBase
{
    ...
    function test_initialization() public {
        ...
        assertEq(
            usdtToken.allowance(address(borrowLend), address(MORPHO)),
            type(uint256).max
        );
        assertEq(
    ...
    function test_setSwapper_success() public {
        ...
        assertEq(
            usdtToken.allowance(address(borrowLend), alice),
            type(uint256).max
        );
        ...
        assertEq(
            usdtToken.allowance(address(borrowLend), bob),
            type(uint256).max
        );
    }
...
contract MorigamiMorphoBorrowAndLend_6dp_TestAccess is
    MorigamiMorphoBorrowAndLend_6dp_TestBase
{
...
contract MorigamiMorphoBorrowAndLend_6dp_TestViews is
    MorigamiMorphoBorrowAndLend_6dp_TestBase
{
...
contract MorigamiMorphoBorrowAndLend_6dp_TestSupply is
    MorigamiMorphoBorrowAndLend_6dp_TestBase
{
    ...
    function test_repayAndWithdraw_success() public {
        ...
        (uint256 debtRepaidAmount, uint256 withdrawnAmount) = borrowLend
            .repayAndWithdraw(25e6, 25e18, alice);
...
contract MorigamiMorphoBorrowAndLend_6dp_TestIncreaseLeverage is
    MorigamiMorphoBorrowAndLend_6dp_TestBase
{
...
contract MorigamiMorphoBorrowAndLend_6dp_TestDecreaseLeverage is
    MorigamiMorphoBorrowAndLend_6dp_TestBase
{
    ...
    function test_decreaseLeverage_success_withSurplus() public {
        ...
        // sUSDe -> DAI = 1.025
        DummyLovTokenSwapper.SwapData memory swapData = DummyLovTokenSwapper
            .SwapData({buyTokenAmount: 102.5e6});
