...
contract MorigamiAaveV3BorrowAndLendNotMatchingDecimalsTestBase is
    MorigamiTest
{
    ...
    address internal constant SPARK_WBTC_DEBT_TOKEN =
...
contract MorigamiAaveV3BorrowAndLendNotMatchingDecimalsTestAdmin is
    MorigamiAaveV3BorrowAndLendNotMatchingDecimalsTestBase
{
...
contract MorigamiAaveV3BorrowAndLendNotMatchingDecimalsTestAccess is
    MorigamiAaveV3BorrowAndLendNotMatchingDecimalsTestBase
{
...
contract MorigamiAaveV3BorrowAndLendNotMatchingDecimalsTestViews is
    MorigamiAaveV3BorrowAndLendNotMatchingDecimalsTestBase
{
...
contract MorigamiAaveV3BorrowAndLendNotMatchingDecimalsTestSupply is
    MorigamiAaveV3BorrowAndLendNotMatchingDecimalsTestBase
{
    ...
    function test_repayAndWithdraw_success() public {
        ...
        (uint256 debtRepaidAmount, uint256 withdrawnAmount) = borrowLend
            .repayAndWithdraw(borrowAmount / 2, supplyAmount / 2, alice);
