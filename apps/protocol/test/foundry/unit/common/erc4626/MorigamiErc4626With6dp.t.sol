...
contract MorigamiErc4626With6dpTestBase is MorigamiTest {
    ...
    function deposit(address user, uint256 amount) internal {
        ...
        emit InKindFees(
            ...
            DEPOSIT_FEE,
            expectedShares.inverseSubtractBps(
                DEPOSIT_FEE,
...
contract MorigamiErc4626With6dpTestAdmin is MorigamiErc4626With6dpTestBase {
...
contract MorigamiErc4626With6dpTestDeposit is MorigamiErc4626With6dpTestBase {
    using MorigamiMath for uint256;
...
contract MorigamiErc4626With6dpTestMint is MorigamiErc4626With6dpTestBase {
    using MorigamiMath for uint256;
    ...
    function test_mint_afterShareIncrease() public {
        ...
        // Can't mint more.
        {
            ...
            vm.expectRevert(
                abi.encodeWithSelector(
                    IMorigamiErc4626.ERC4626ExceededMaxMint.selector,
                    alice,
                    _max + 1,
                    _max
                )
...
contract MorigamiErc4626With6dpTestWithdraw is MorigamiErc4626With6dpTestBase {
    using MorigamiMath for uint256;
    ...
    function test_withdraw_afterShareIncrease() public {
        ...
        // Can't withdraw more
        {
            vm.expectRevert(
                abi.encodeWithSelector(
                    IMorigamiErc4626.ERC4626ExceededMaxWithdraw.selector,
                    alice,
                    _max + 1,
                    _max
                )
...
contract MorigamiErc4626With6dpTestRedeem is MorigamiErc4626With6dpTestBase {
    using MorigamiMath for uint256;
    ...
    function test_redeem_afterShareIncrease() public {
        ...
        // Can't redeem more.
        {
            vm.expectRevert(
                abi.encodeWithSelector(
                    IMorigamiErc4626.ERC4626ExceededMaxRedeem.selector,
                    alice,
                    _max + 1,
                    _max
                )
...
contract MorigamiErc4626TestAttacksJP is MorigamiErc4626With6dpTestBase {
