...
contract MockCaller {
    MorigamiCircuitBreakerAllUsersPerPeriod public breaker;

    function setBreaker(address _breaker) external {
        breaker = MorigamiCircuitBreakerAllUsersPerPeriod(_breaker);
    }
...
/* solhint-disable func-name-mixedcase, not-rely-on-time, no-console */
contract MorigamiCircuitBreakerTestBase is MorigamiTest {
    ...
    function setUp() public {
        breaker = new MorigamiCircuitBreakerAllUsersPerPeriod(
            origamiMultisig,
            proxy,
            1 days,
            24,
...
contract MorigamiCircuitBreakerTestAccess is MorigamiCircuitBreakerTestBase {
...
contract MorigamiCircuitBreakerTestAdmin is MorigamiCircuitBreakerTestBase {
...
contract MorigamiCircuitBreakerTestPreCheck is MorigamiCircuitBreakerTestBase {
    ...
    function doCheck(
        uint256 amt,
        uint256 bucketIndex,
        uint256 utilisationAfter
    ) internal {
        assertEq(
            breaker.currentUtilisation(),
            utilisationAfter - amt,
            "utilisationBefore"
        );
        breaker.preCheck(amt);
        assertEq(
            breaker.bucketIndex() % breaker.nBuckets(),
            bucketIndex,
            "bucketIndex"
        );
        assertEq(
    ...
    function test_preCheck_1day_24buckets() public {
        ...
        {
            warp(0, 4, 0, 1);
            (ebkts[0], ebkts[1], ebkts[2], ebkts[4]) = (
                20e18,
                20e18,
                10e18,
                10e18
        ...
        {
            warp(0, 23, 30, 1);
            (ebkts[0], ebkts[1], ebkts[2], ebkts[4], ebkts[23]) = (
                20e18,
                20e18,
                10e18,
                20e18,
    ...
    function test_gas() public {
        ...
        caller.setBreaker(address(breaker));
    ...
    function test_preCheck_2day_8buckets() public {
        ...
        {
            warp(1, 23, 30, 1);
            (ebkts[0], ebkts[1], ebkts[2], ebkts[4], ebkts[7]) = (
                20e18,
                20e18,
                10e18,
                20e18,
