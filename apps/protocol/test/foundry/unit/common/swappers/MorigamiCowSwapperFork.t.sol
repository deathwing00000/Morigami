...
contract MorigamiCowSwapperForkTestBase is MorigamiTest {
    MorigamiCowSwapper public swapper;
    IMorigamiOracle public sdaiOracle;
    IMorigamiOracle public susdeOracle;
    IMorigamiOracle public limitPriceOracle;
    ...
    function setUp() public {
        ...
        cowSwapSettlement = MockCowSettlement(
        ...
        sdaiOracle = new MorigamiErc4626Oracle(
        ...
        susdeOracle = new MorigamiErc4626Oracle(
            IMorigamiOracle.BaseOracleParams(
                "sUSDe/USD",
                sUSDe,
                18,
        ...
        limitPriceOracle = new MorigamiCrossRateOracle(
            IMorigamiOracle.BaseOracleParams("sDAI/sUSDe", sDAI, 18, sUSDe, 18),
            address(sdaiOracle),
            address(susdeOracle),
            address(0)
        );
