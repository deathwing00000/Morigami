...
contract Mock is MorigamiElevatedAccess {
    constructor(
...
contract MorigamiElevatedAccessTestBase is MorigamiTest {
    Mock public mock;
...
contract MorigamiElevatedAccessTest is MorigamiElevatedAccessTestBase {
...
contract MorigamiElevatedAccessTestSetters is MorigamiElevatedAccessTestBase {
...
contract MorigamiElevatedAccessTestModifiers is MorigamiElevatedAccessTestBase {
    function test_onlyElevatedAccess() public {
        ...
        setExplicitAccess(
            mock,
            alice,
            Mock.validateOnlyElevatedAccess.selector,
            true
        );
        vm.startPrank(alice);
        mock.validateOnlyElevatedAccess();
