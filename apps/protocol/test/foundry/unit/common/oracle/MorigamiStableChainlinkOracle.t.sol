...
contract MorigamiStableChainlinkOracleTestBase is MorigamiTest {
...
contract MorigamiStableChainlinkOracleTestInit is
    MorigamiStableChainlinkOracleTestBase
{
...
contract MorigamiStableChainlinkOracleTestAdmin is
    MorigamiStableChainlinkOracleTestBase
{
...
contract MorigamiStableChainlinkOracleTestAccess is
    MorigamiStableChainlinkOracleTestBase
{
    function setUp() public {
        _setUp();
...
contract MorigamiStableChainlinkOracle1_LatestPrice is
    MorigamiStableChainlinkOracleTestBase
{
    function setUp() public {
        _setUp();
    ...
    function test_latestPrice_fail_invalidRoundId() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IMorigamiOracle.InvalidOracleData.selector,
                address(oracle1)
            )
        );
        oOracle1.latestPrice(
...
contract MorigamiStableChainlinkOracle2_LatestPrice is
    MorigamiStableChainlinkOracleTestBase
{
    function setUp() public {
        _setUp();
    ...
    function test_latestPrice_noValidation() public {
        ...
        vm.mockCall(
            ...
            abi.encode(0, 1e18, 0, 0, 0)
        );
        assertEq(
            oOracle2.latestPrice(
                IMorigamiOracle.PriceType.SPOT_PRICE,
                MorigamiMath.Rounding.ROUND_DOWN
            ),
            1e18
...
contract MorigamiStableChainlinkOracle3_LatestPrice is
    MorigamiStableChainlinkOracleTestBase
{
    function setUp() public {
        _setUp();
    ...
    function test_latestPrice_noValidation() public {
        ...
        vm.mockCall(
            ...
            abi.encode(0, 1e24, 0, 0, 0)
        );
        assertEq(
            oOracle3.latestPrice(
                IMorigamiOracle.PriceType.SPOT_PRICE,
                MorigamiMath.Rounding.ROUND_DOWN
            ),
            1e18
