...
contract MorigamiErc4626OracleTest is MorigamiTest {
    DummyOracle public clUsdeUsdOracle;
    MorigamiStableChainlinkOracle public oUsdeToUsdOracle;
    MorigamiErc4626Oracle public oSUsdeToUsdOracle;
    ...
    function setUp() public {
        ...
        oUsdeToUsdOracle = new MorigamiStableChainlinkOracle(
            origamiMultisig,
        ...
        oSUsdeToUsdOracle = new MorigamiErc4626Oracle(
            IMorigamiOracle.BaseOracleParams(
                "sUSDe/USD",
                address(sUsdeToken),
                18,
    ...
    function test_latestPrices() public {
        (
            ...
            address baseAsset,
            address quoteAsset
        ) = oSUsdeToUsdOracle.latestPrices(
                IMorigamiOracle.PriceType.SPOT_PRICE,
                MorigamiMath.Rounding.ROUND_UP,
                IMorigamiOracle.PriceType.HISTORIC_PRICE,
                MorigamiMath.Rounding.ROUND_DOWN
...
contract MorigamiErc4626OracleNoQuoteAssetOracleTest is MorigamiTest {
    MorigamiErc4626Oracle public oSUsdeToUsdOracle;
    MockSDaiToken public sUsdeToken;
