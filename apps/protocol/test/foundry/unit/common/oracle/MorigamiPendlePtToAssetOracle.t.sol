...
contract MorigamiPendlePtToAssetOracleTest is MorigamiTest {
    MorigamiPendlePtToAssetOracle public oOracle;

    address internal constant pendleOracle =
        0x9a9Fa8338dd5E5B2188006f1Cd2Ef26d921650C2;

    address internal constant pt_sUSDE_market =
        0xd1D7D99764f8a52Aff007b7831cc02748b2013b5;
    uint32 internal constant twapDuration = 900;

    address internal constant pt_sUSDe =
    ...
    function setUp() public {
        ...
        oOracle = new MorigamiPendlePtToAssetOracle(
