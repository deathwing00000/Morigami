...
import {MorigamiScaledOracle} from "contracts/common/oracle/MorigamiScaledOracle.sol";
...
contract MorigamiScaledOracleTestBase is MorigamiTest {
    MorigamiFixedPriceOracle public referenceOracle;
    MorigamiFixedPriceOracle public scalarOracle;

    MorigamiScaledOracle public scaledOracleMultiply;
    MorigamiScaledOracle public scaledOracleDivide;
    ...
    function setupOracles() internal {
        ...
        referenceOracle = new MorigamiFixedPriceOracle(
        ...
        scalarOracle = new MorigamiFixedPriceOracle(
            IMorigamiOracle.BaseOracleParams(
                "PT_DISCOUNT_FACTOR",
        ...
        scaledOracleMultiply = new MorigamiScaledOracle(
            IMorigamiOracle.BaseOracleParams(
                "TOKEN2/USD * DF",
                token1,
                6,
        ...
        // referenceOracle / scalarOracle
        scaledOracleDivide = new MorigamiScaledOracle(
            IMorigamiOracle.BaseOracleParams(
                "TOKEN2/USD / DF",
                token1,
                6,
...
contract MorigamiScaledOracleTestInit is MorigamiScaledOracleTestBase {
    function test_initialization() public {
        ...
        assertEq(
            address(scaledOracleMultiply.quoteAsset()),
            INTERNAL_USD_ADDRESS
        );
        ...
        assertEq(
            address(scaledOracleDivide.quoteAsset()),
            INTERNAL_USD_ADDRESS
        );
...
contract MorigamiScaledOracleTestLatestPriceMultiply is
    MorigamiScaledOracleTestBase
{
    ...
    function test_latestPrice_success() public {
        assertEq(
            scaledOracleMultiply.latestPrice(
...
contract MorigamiScaledOracleTestLatestPriceDivide is
    MorigamiScaledOracleTestBase
{
    function setUp() public {
        _setUp();
    ...
    function test_latestPrice_success() public {
        assertEq(
            scaledOracleDivide.latestPrice(
                IMorigamiOracle.PriceType.SPOT_PRICE,
                MorigamiMath.Rounding.ROUND_DOWN
            ),
