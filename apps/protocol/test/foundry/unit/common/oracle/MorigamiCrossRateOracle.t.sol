...
contract MorigamiCrossRateOracleTestBase is MorigamiTest {
    DummyOracle public oracle1;
    DummyOracle public oracle2;
    DummyOracle public oracle3;
    DummyOracle public oracle3_inverse;
    MorigamiStableChainlinkOracle public oOracle1;
    MorigamiStableChainlinkOracle public oOracle2;
    MorigamiStableChainlinkOracle public oOracle3;
    MorigamiStableChainlinkOracle public oOracle3_inverse;
    MorigamiCrossRateOracle public crOracle_1_2;
    MorigamiCrossRateOracle public crOracle_2_3;
    MorigamiCrossRateOracle public crOracle_2_3_inverse;
    MorigamiCrossRateOracle public crOracle_1_2_3;
    ...
    function setupDaiUsdcOracle() internal {
        ...
        oOracle1 = new MorigamiStableChainlinkOracle(
            origamiMultisig,
        ...
        oOracle2 = new MorigamiStableChainlinkOracle(
            origamiMultisig,
            IMorigamiOracle.BaseOracleParams(
                "TOKEN2/USD",
                token2,
        ...
        oOracle3 = new MorigamiStableChainlinkOracle(
            origamiMultisig,
            IMorigamiOracle.BaseOracleParams(
                "TOKEN3/USD",
                token3,
        ...
        crOracle_1_2 = new MorigamiCrossRateOracle(
            IMorigamiOracle.BaseOracleParams(
                "TOKEN1/TOKEN2",
                token1,
                18,
        ...
        crOracle_2_3 = new MorigamiCrossRateOracle(
            IMorigamiOracle.BaseOracleParams(
                "TOKEN2/TOKEN3",
                token2,
                6,
        ...
        // 18 decimals for baseAsset, 6 decimals for quoteAsset
        oOracle3_inverse = new MorigamiStableChainlinkOracle(
            origamiMultisig,
            IMorigamiOracle.BaseOracleParams(
                "USD/TOKEN3",
                INTERNAL_USD_ADDRESS,
        ...
        crOracle_2_3_inverse = new MorigamiCrossRateOracle(
            IMorigamiOracle.BaseOracleParams(
                "TOKEN2/TOKEN3",
                token2,
                6,
        ...
        crOracle_1_2_3 = new MorigamiCrossRateOracle(
            IMorigamiOracle.BaseOracleParams(
...
contract MorigamiCrossRateOracleTestInit is MorigamiCrossRateOracleTestBase {
    function test_initialization() public {
        ...
        assertEq(
            address(crOracle_2_3_inverse.baseAssetOracle()),
            address(oOracle2)
        );
        assertEq(
            address(crOracle_2_3_inverse.quoteAssetOracle()),
            address(oOracle3_inverse)
        );
    ...
    function test_constructor_failure() public {
        ...
        // base on this oracle doesn't match base (token1)
        {
            vm.expectRevert(
                abi.encodeWithSelector(
                    CommonEventsAndErrors.InvalidParam.selector
                )
            );
            new MorigamiCrossRateOracle(
                IMorigamiOracle.BaseOracleParams(
                    "TOKEN1/TOKEN2",
                    token1,
                    18,
        ...
        {
            MorigamiStableChainlinkOracle oOracleX = new MorigamiStableChainlinkOracle(
                    origamiMultisig,
                    IMorigamiOracle.BaseOracleParams(
                        "TOKEN3/TOKEN2",
                        token3,
    ...
    function test_constructor_succeed_muldiv() public {
        ...
        // Divide
        {
            MorigamiCrossRateOracle _ooracle = new MorigamiCrossRateOracle(
                IMorigamiOracle.BaseOracleParams(
                    "TOKEN1/TOKEN2",
                    token1,
                    18,
...
contract MorigamiCrossRateOracleTestLatestPrice_1_2 is
    MorigamiCrossRateOracleTestBase
{
    ...
    function test_latestPrice_fail_denominator_zero() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                IMorigamiOracle.InvalidPrice.selector,
                address(oOracle2),
                0
            )
        );
...
contract MorigamiCrossRateOracleTestLatestPrice_2_3 is
    MorigamiCrossRateOracleTestBase
{
    function setUp() public {
        _setUp();
...
contract MorigamiCrossRateOracleTestLatestPrice_1_2_3 is
    MorigamiCrossRateOracleTestBase
{
    function setUp() public {
        _setUp();
    ...
    function test_pricecheck() public {
        ...
        oOracle3.setValidSpotPriceRange(0.999e18, 1.111e18);
...
contract MorigamiCrossRateOracleTestLatestPrice_2_3_Multiply is
    MorigamiCrossRateOracleTestBase
{
    function setUp() public {
        _setUp();
    ...
    function test_latestPrice_success_2() public {
        ...
        assertEq(
            crOracle_2_3_inverse.latestPrice(
                IMorigamiOracle.PriceType.SPOT_PRICE,
                MorigamiMath.Rounding.ROUND_DOWN
            ),
            0.95006289e18
