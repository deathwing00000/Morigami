...
struct LovTokenContracts {
    ...
    MorigamiStableChainlinkOracle usdeToUsdtOracle;
    MorigamiErc4626Oracle sUsdeToUsdtOracle;
    IMorigamiSwapper swapper;
    MorigamiMorphoBorrowAndLend borrowLend;
}

/* solhint-disable max-states-count */
contract Morigami_lov_sUSDe_USDT_TestDeployer {
    ...
    MorigamiStableChainlinkOracle public usdeToUsdtOracle;
    MorigamiErc4626Oracle public sUsdeToUsdtOracle;
    ...
    function _setupLovToken() private {
        usdeToUsdtOracle = new MorigamiStableChainlinkOracle(
            owner,
        ...
        sUsdeToUsdtOracle = new MorigamiErc4626Oracle(
            IMorigamiOracle.BaseOracleParams(
                "sUSDe/USDT",
                address(sUsdeToken),
