...
contract Morigami_lovToken_TestDeployer {
        ...
        )
    {
        ...
        reserveToken = new DummyMintableToken(owner, "sDAI", "sDAI", 18);
        debtToken = new DummyMintableToken(owner, "wBTC", "wBTC", 18);
        ...
        )
    {
        ...
        {
            reserveToken = IERC20(Constants.SDAI_ADDRESS);
            debtToken = IERC20(Constants.WBTC_ADDRESS);

            // swapper = new MorigamiDexAggregatorSwapper(owner);
            swapper = new DummyLovTokenSwapper();

            clReserveToDebtOracle = IAggregatorV3Interface(
                Constants.BTC_USD_ORACLE
            );
        }
    ...
    function _setuplovToken() private {
        ...
        lovToken = new MorigamiLovToken(
            owner,
            "Morigami lov-wBTC-sDAI-2x-short",
            "lov-wBTC-sDAI-2x-short",
