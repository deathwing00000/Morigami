...
abstract contract BaseInvariantTest is StdInvariant, MorigamiTest {
    ...
    function setUp() public virtual {
        ...
        vm.label({
            account: address(timestampStore),
            newLabel: "TimestampStore"
        });
    ...
    function targetSelectors(
        ...
        targetContract(addr);
        targetSelector(
            StdInvariant.FuzzSelector({addr: addr, selectors: fnSelectors})
        );
    }
}
