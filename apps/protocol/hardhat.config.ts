...
module.exports = {
  ...
  networks: {
    ...
    "flow-testnet": {
      ...
      accounts: process.env.FLOW_TESTNET_ADDRESS_PRIVATE_KEY
        ? [process.env.FLOW_TESTNET_ADDRESS_PRIVATE_KEY]
        : [],
      gasPrice:
        parseInt(process.env.FLOW_TESTNET_GAS_IN_GWEI || "1") * 1000000000,
    },
    anvil: {
