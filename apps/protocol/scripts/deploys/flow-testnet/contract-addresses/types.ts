...
export interface ContractAddresses {
  ...
  EXTERNAL: {
    ...
    CHAINLINK: {
      ANKRFLOW_USD_ORACLE: string;
      WFLOW_USD_ORACLE: string;
      ANKRFLOW_WFLOW_ORACLE: string;
    ...
    MORE: {
      V3_POOL_ADDRESS_PROVIDER: string;
    };
    ZEROLEND: {
