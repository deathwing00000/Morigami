...
import {
  ...
  MorigamiVolatileChainlinkOracle,
  MorigamiVolatileChainlinkOracle__factory,
  ...
  MorigamiErc4626AndDexAggregatorSwapper,
  MorigamiErc4626AndDexAggregatorSwapper__factory,
  IMorpho,
  IMorpho__factory,
...
import { CONTRACTS as FLOW_TESTNET_CONTRACTS } from "./flow-testnet";
...
export async function getDeployedContracts1(
  ...
  if (network.name === "flow-testnet") {
    ...
    return await applyOverrides(FLOW_TESTNET_CONTRACTS, applyOverridesPath);
  }
  console.log(`No contracts configured for ${network.name}`);
  throw new Error(`No contracts configured for ${network.name}`);
}
...
export interface ContractInstances {
  ...
  ORACLES: {
    ANKRFLOW_WFLOW: MorigamiVolatileChainlinkOracle;
  ...
  LOV_TEST_ANKRFLOW_FLOW: ISparkType;
  ...
  EXTERNAL: {
    ANKRFLOW_TOKEN: IERC20Metadata;
    WFLOW_TOKEN: IERC20Metadata;
    ...
    MORE: {
      V3_POOL_ADDRESS_PROVIDER: IPoolAddressesProvider;
    };
    PENDLE: {
      SUSDE_OCT24: {
...
export function connectToContracts1(
  owner: Signer,
  ...
  return {
    ...
    ORACLES: {
      ANKRFLOW_WFLOW: MorigamiVolatileChainlinkOracle__factory.connect(
        ADDRS.ORACLES.WETH_DAI,
        owner
      ),
      USDE_DAI: MorigamiStableChainlinkOracle__factory.connect(
        ADDRS.ORACLES.USDE_DAI,
        owner
      ),
      SUSDE_DAI: MorigamiErc4626Oracle__factory.connect(
        ADDRS.ORACLES.SUSDE_DAI,
        owner
      ),
      WEETH_WETH: MorigamiEtherFiEthToEthOracle__factory.connect(
        ADDRS.ORACLES.WEETH_WETH,
        owner
      ),
      EZETH_WETH: MorigamiRenzoEthToEthOracle__factory.connect(
        ADDRS.ORACLES.EZETH_WETH,
        owner
      ),
      STETH_WETH: MorigamiStableChainlinkOracle__factory.connect(
        ADDRS.ORACLES.STETH_WETH,
        owner
      ),
      WSTETH_WETH: MorigamiWstEthToEthOracle__factory.connect(
        ADDRS.ORACLES.WSTETH_WETH,
        owner
      ),
      WOETH_WETH: MorigamiErc4626Oracle__factory.connect(
        ADDRS.ORACLES.WOETH_WETH,
        owner
      ),
      WETH_DAI: MorigamiVolatileChainlinkOracle__factory.connect(
        ADDRS.ORACLES.WETH_DAI,
        owner
      ),
      WBTC_DAI: MorigamiVolatileChainlinkOracle__factory.connect(
        ADDRS.ORACLES.WBTC_DAI,
        owner
      ),
      WETH_WBTC: MorigamiVolatileChainlinkOracle__factory.connect(
        ADDRS.ORACLES.WETH_WBTC,
        owner
      ),
      WETH_SDAI: MorigamiCrossRateOracle__factory.connect(
        ADDRS.ORACLES.WETH_SDAI,
        owner
      ),
      WBTC_SDAI: MorigamiCrossRateOracle__factory.connect(
        ADDRS.ORACLES.WBTC_SDAI,
        owner
      ),
      DAI_USD: MorigamiStableChainlinkOracle__factory.connect(
        ADDRS.ORACLES.DAI_USD,
        owner
      ),
      SDAI_DAI: MorigamiErc4626Oracle__factory.connect(
        ADDRS.ORACLES.SDAI_DAI,
        owner
      ),
      PT_SUSDE_OCT24_USDE: MorigamiPendlePtToAssetOracle__factory.connect(
        ADDRS.ORACLES.PT_SUSDE_OCT24_USDE,
        owner
      ),
      PT_SUSDE_OCT24_DAI: MorigamiCrossRateOracle__factory.connect(
        ADDRS.ORACLES.PT_SUSDE_OCT24_DAI,
        owner
      ),
      PT_SUSDE_MAR_2025_USDE: MorigamiPendlePtToAssetOracle__factory.connect(
        ADDRS.ORACLES.PT_SUSDE_MAR_2025_USDE,
        owner
      ),
      PT_SUSDE_MAR_2025_DAI: MorigamiCrossRateOracle__factory.connect(
        ADDRS.ORACLES.PT_SUSDE_MAR_2025_DAI,
        owner
      ),
      PT_SUSDE_MAR_2025_DISCOUNT_TO_MATURITY:
        MorigamiVolatileChainlinkOracle__factory.connect(
          ADDRS.ORACLES.PT_SUSDE_MAR_2025_DISCOUNT_TO_MATURITY,
          owner
        ),
      PT_SUSDE_MAR_2025_DAI_WITH_DISCOUNT_TO_MATURITY:
        MorigamiScaledOracle__factory.connect(
          ADDRS.ORACLES.PT_SUSDE_MAR_2025_DAI_WITH_DISCOUNT_TO_MATURITY,
          owner
        ),
      MKR_DAI: MorigamiVolatileChainlinkOracle__factory.connect(
        ADDRS.ORACLES.MKR_DAI,
        owner
      ),
      AAVE_USDC: MorigamiVolatileChainlinkOracle__factory.connect(
        ADDRS.ORACLES.AAVE_USDC,
        owner
      ),
      SDAI_USDC: MorigamiErc4626Oracle__factory.connect(
        ADDRS.ORACLES.SDAI_USDC,
        owner
      ),
      USD0pp_USD0: MorigamiVolatileCurveEmaOracle__factory.connect(
        ADDRS.ORACLES.USD0pp_USD0,
        owner
      ),
      USD0pp_USDC: MorigamiFixedPriceOracle__factory.connect(
        ADDRS.ORACLES.USD0pp_USDC,
        owner
      ),
      USD0_USDC: MorigamiVolatileCurveEmaOracle__factory.connect(
        ADDRS.ORACLES.USD0_USDC,
        owner
      ),
      RSWETH_WETH: MorigamiVolatileChainlinkOracle__factory.connect(
        ADDRS.ORACLES.RSWETH_WETH,
        owner
      ),
      PT_EBTC_DEC24_EBTC: MorigamiPendlePtToAssetOracle__factory.connect(
        ADDRS.ORACLES.PT_EBTC_DEC24_EBTC,
        owner
      ),
      PT_CORN_LBTC_DEC24_LBTC: MorigamiPendlePtToAssetOracle__factory.connect(
        ADDRS.ORACLES.PT_CORN_LBTC_DEC24_LBTC,
        owner
      ),
      WETH_CBBTC: MorigamiVolatileChainlinkOracle__factory.connect(
        ADDRS.ORACLES.WETH_CBBTC,
        owner
      ),
    },
    SWAPPERS: {
      DIRECT_SWAPPER: MorigamiDexAggregatorSwapper__factory.connect(
        ADDRS.SWAPPERS.DIRECT_SWAPPER,
        owner
      ),
      SUSDE_SWAPPER: MorigamiErc4626AndDexAggregatorSwapper__factory.connect(
        ADDRS.SWAPPERS.SUSDE_SWAPPER,
        owner
      ),
    },
    FLASHLOAN_PROVIDERS: {
      SPARK: MorigamiAaveV3FlashLoanProvider__factory.connect(
        ADDRS.FLASHLOAN_PROVIDERS.SPARK,
        owner
      ),
    },
    LOV_TEST_ANKRFLOW_FLOW: {
      TOKEN: MorigamiLovToken__factory.connect(
        ADDRS.LOV_TEST_ANKRFLOW_FLOW.TOKEN,
        owner
      ),
      SPARK_BORROW_LEND: MorigamiAaveV3BorrowAndLend__factory.connect(
        ADDRS.LOV_TEST_ANKRFLOW_FLOW.SPARK_BORROW_LEND,
        owner
      ),
      MANAGER: MorigamiLovTokenFlashAndBorrowManager__factory.connect(
        ADDRS.LOV_TEST_ANKRFLOW_FLOW.MANAGER,
        owner
      ),
    },
    LOV_SUSDE_A: {
      MORPHO_BORROW_LEND: MorigamiMorphoBorrowAndLend__factory.connect(
        ADDRS.LOV_SUSDE_A.MORPHO_BORROW_LEND,
        owner
      ),
      TOKEN: MorigamiLovToken__factory.connect(ADDRS.LOV_SUSDE_A.TOKEN, owner),
      MANAGER: MorigamiLovTokenMorphoManager__factory.connect(
    ...
    LOV_WETH_DAI_LONG_A: {
      ...
      MANAGER: MorigamiLovTokenFlashAndBorrowManager__factory.connect(
        ADDRS.LOV_WETH_DAI_LONG_A.MANAGER,
        owner
      ),
    },
    LOV_WETH_SDAI_SHORT_A: {
      ...
      MANAGER: MorigamiLovTokenFlashAndBorrowManager__factory.connect(
        ADDRS.LOV_WETH_SDAI_SHORT_A.MANAGER,
        owner
      ),
    },
    LOV_WBTC_DAI_LONG_A: {
      ...
      MANAGER: MorigamiLovTokenFlashAndBorrowManager__factory.connect(
        ADDRS.LOV_WBTC_DAI_LONG_A.MANAGER,
        owner
      ),
    },
    LOV_WBTC_SDAI_SHORT_A: {
      ...
      SPARK_BORROW_LEND: MorigamiAaveV3BorrowAndLend__factory.connect(
        ADDRS.LOV_WBTC_SDAI_SHORT_A.SPARK_BORROW_LEND,
        owner
      ),
      MANAGER: MorigamiLovTokenFlashAndBorrowManager__factory.connect(
        ADDRS.LOV_WBTC_SDAI_SHORT_A.MANAGER,
        owner
      ),
    },
    LOV_WETH_WBTC_LONG_A: {
      ...
      MANAGER: MorigamiLovTokenFlashAndBorrowManager__factory.connect(
        ADDRS.LOV_WETH_WBTC_LONG_A.MANAGER,
        owner
      ),
    },
    ...
    LOV_PT_SUSDE_OCT24_A: {
      ...
      MANAGER: MorigamiLovTokenMorphoManagerMarketAL__factory.connect(
    ...
    LOV_PT_EBTC_DEC24_A: {
      ...
      ZEROLEND_BORROW_LEND: MorigamiAaveV3BorrowAndLend__factory.connect(
        ADDRS.LOV_PT_EBTC_DEC24_A.ZEROLEND_BORROW_LEND,
        owner
      ),
      MANAGER: MorigamiLovTokenFlashAndBorrowManager__factory.connect(
        ADDRS.LOV_PT_EBTC_DEC24_A.MANAGER,
        owner
      ),
    },
    ...
    VAULTS: {
      SUSDSpS: {
        TOKEN: MorigamiSuperSavingsUsdsVault__factory.connect(
          ADDRS.VAULTS.SUSDSpS.TOKEN,
          owner
        ),
        MANAGER: MorigamiSuperSavingsUsdsManager__factory.connect(
          ADDRS.VAULTS.SUSDSpS.MANAGER,
          owner
        ),
        COW_SWAPPER: MorigamiCowSwapper__factory.connect(
    ...
    EXTERNAL: {
      ANKRFLOW_TOKEN: IERC20Metadata__factory.connect(
        ADDRS.EXTERNAL.ANKRFLOW_TOKEN,
        owner
      ),
      WFLOW_TOKEN: IERC20Metadata__factory.connect(
        ADDRS.EXTERNAL.WFLOW_TOKEN,
        owner
      ),
      WETH_TOKEN: IERC20Metadata__factory.connect(
        ADDRS.EXTERNAL.WETH_TOKEN,
        owner
      ),
      WBTC_TOKEN: IERC20Metadata__factory.connect(
        ADDRS.EXTERNAL.WBTC_TOKEN,
        owner
      ),
      MAKER_DAO: {
        DAI_TOKEN: IERC20Metadata__factory.connect(
          ADDRS.EXTERNAL.MAKER_DAO.DAI_TOKEN,
          owner
        ),
        SDAI_TOKEN: IERC4626__factory.connect(
          ADDRS.EXTERNAL.MAKER_DAO.SDAI_TOKEN,
          owner
        ),
        MKR_TOKEN: IERC20Metadata__factory.connect(
          ADDRS.EXTERNAL.MAKER_DAO.MKR_TOKEN,
          owner
        ),
      },
      SKY: {
        USDS_TOKEN: IERC20Metadata__factory.connect(
          ADDRS.EXTERNAL.SKY.USDS_TOKEN,
          owner
        ),
        SUSDS_TOKEN: IERC4626__factory.connect(
          ADDRS.EXTERNAL.SKY.SUSDS_TOKEN,
          owner
        ),
        SKY_TOKEN: IERC20Metadata__factory.connect(
          ADDRS.EXTERNAL.SKY.SKY_TOKEN,
          owner
        ),
      },
      CIRCLE: {
        USDC_TOKEN: IERC20Metadata__factory.connect(
          ADDRS.EXTERNAL.CIRCLE.USDC_TOKEN,
          owner
        ),
      },
      ETHENA: {
        USDE_TOKEN: IERC20Metadata__factory.connect(
          ADDRS.EXTERNAL.ETHENA.USDE_TOKEN,
          owner
        ),
        SUSDE_TOKEN: IERC4626__factory.connect(
          ADDRS.EXTERNAL.ETHENA.SUSDE_TOKEN,
          owner
        ),
      },
      ETHERFI: {
        WEETH_TOKEN: IERC20Metadata__factory.connect(
          ADDRS.EXTERNAL.ETHERFI.WEETH_TOKEN,
          owner
        ),
        LIQUIDITY_POOL: IEtherFiLiquidityPool__factory.connect(
          ADDRS.EXTERNAL.ETHERFI.LIQUIDITY_POOL,
          owner
        ),
        EBTC_TOKEN: IERC20Metadata__factory.connect(
          ADDRS.EXTERNAL.ETHERFI.EBTC_TOKEN,
          owner
        ),
      },
      RENZO: {
        EZETH_TOKEN: IERC20Metadata__factory.connect(
          ADDRS.EXTERNAL.RENZO.EZETH_TOKEN,
          owner
        ),
        RESTAKE_MANAGER: IRenzoRestakeManager__factory.connect(
          ADDRS.EXTERNAL.RENZO.RESTAKE_MANAGER,
          owner
        ),
      },
      LIDO: {
        STETH_TOKEN: IERC20Metadata__factory.connect(
          ADDRS.EXTERNAL.LIDO.STETH_TOKEN,
          owner
        ),
        WSTETH_TOKEN: IERC20Metadata__factory.connect(
          ADDRS.EXTERNAL.LIDO.WSTETH_TOKEN,
          owner
        ),
      },
      ORIGIN: {
        OETH_TOKEN: IERC4626__factory.connect(
          ADDRS.EXTERNAL.ORIGIN.OETH_TOKEN,
          owner
        ),
        WOETH_TOKEN: IERC4626__factory.connect(
          ADDRS.EXTERNAL.ORIGIN.WOETH_TOKEN,
          owner
        ),
      },
      USUAL: {
        USD0pp_TOKEN: IERC20Metadata__factory.connect(
          ADDRS.EXTERNAL.USUAL.USD0pp_TOKEN,
          owner
        ),
        USD0_TOKEN: IERC20Metadata__factory.connect(
          ADDRS.EXTERNAL.USUAL.USD0_TOKEN,
          owner
        ),
      },
      SWELL: {
        RSWETH_TOKEN: IERC20Metadata__factory.connect(
          ADDRS.EXTERNAL.SWELL.RSWETH_TOKEN,
          owner
        ),
      },
      LOMBARD: {
        LBTC_TOKEN: IERC20Metadata__factory.connect(
          ADDRS.EXTERNAL.LOMBARD.LBTC_TOKEN,
          owner
        ),
      },
      COINBASE: {
        CBBTC_TOKEN: IERC20Metadata__factory.connect(
          ADDRS.EXTERNAL.COINBASE.CBBTC_TOKEN,
          owner
        ),
      },
      REDSTONE: {
        USDE_USD_ORACLE: AggregatorV3Interface__factory.connect(
          ADDRS.EXTERNAL.REDSTONE.USDE_USD_ORACLE,
          owner
        ),
        SUSDE_USD_ORACLE: AggregatorV3Interface__factory.connect(
          ADDRS.EXTERNAL.REDSTONE.SUSDE_USD_ORACLE,
          owner
        ),
        WEETH_WETH_ORACLE: AggregatorV3Interface__factory.connect(
          ADDRS.EXTERNAL.REDSTONE.WEETH_WETH_ORACLE,
          owner
        ),
        WEETH_USD_ORACLE: AggregatorV3Interface__factory.connect(
          ADDRS.EXTERNAL.REDSTONE.WEETH_USD_ORACLE,
          owner
        ),
        EZETH_WETH_ORACLE: AggregatorV3Interface__factory.connect(
          ADDRS.EXTERNAL.REDSTONE.EZETH_WETH_ORACLE,
          owner
        ),
      },
      CHAINLINK: {
        ETH_USD_ORACLE: AggregatorV3Interface__factory.connect(
          ADDRS.EXTERNAL.CHAINLINK.ETH_USD_ORACLE,
          owner
        ),
        STETH_ETH_ORACLE: AggregatorV3Interface__factory.connect(
          ADDRS.EXTERNAL.CHAINLINK.STETH_ETH_ORACLE,
          owner
        ),
      },
      MORPHO: {
        SINGLETON: IMorpho__factory.connect(
          ADDRS.EXTERNAL.MORPHO.SINGLETON,
          owner
        ),
        IRM: AdaptiveCurveIrm__factory.connect(
          ADDRS.EXTERNAL.MORPHO.IRM,
          owner
        ),
        ORACLE: {
          SUSDE_DAI: MorphoChainlinkOracleV2__factory.connect(
            ADDRS.EXTERNAL.MORPHO.ORACLE.SUSDE_DAI,
            owner
          ),
          USDE_DAI: MorphoChainlinkOracleV2__factory.connect(
            ADDRS.EXTERNAL.MORPHO.ORACLE.USDE_DAI,
            owner
          ),
          WEETH_WETH: MorphoChainlinkOracleV2__factory.connect(
            ADDRS.EXTERNAL.MORPHO.ORACLE.WEETH_WETH,
            owner
          ),
          EZETH_WETH: MorphoChainlinkOracleV2__factory.connect(
      ...
      SPARK: {
        POOL_ADDRESS_PROVIDER: IPoolAddressesProvider__factory.connect(
          ADDRS.EXTERNAL.SPARK.POOL_ADDRESS_PROVIDER,
          owner
        ),
      },
      AAVE: {
        AAVE_TOKEN: IERC20Metadata__factory.connect(
          ADDRS.EXTERNAL.AAVE.AAVE_TOKEN,
          owner
        ),
        V3_MAINNET_POOL_ADDRESS_PROVIDER:
          IPoolAddressesProvider__factory.connect(
            ADDRS.EXTERNAL.AAVE.V3_MAINNET_POOL_ADDRESS_PROVIDER,
            owner
          ),
        V3_LIDO_POOL_ADDRESS_PROVIDER: IPoolAddressesProvider__factory.connect(
          ADDRS.EXTERNAL.AAVE.V3_LIDO_POOL_ADDRESS_PROVIDER,
          owner
        ),
      },
      MORE: {
        V3_POOL_ADDRESS_PROVIDER: IPoolAddressesProvider__factory.connect(
      ...
      PENDLE: {
        SUSDE_OCT24: {
          PT_TOKEN: IERC20Metadata__factory.connect(
    ...
    MAINNET_TEST: {
      SWAPPERS: {
        COW_SWAPPER_1: MorigamiCowSwapper__factory.connect(
          ADDRS.MAINNET_TEST.SWAPPERS.COW_SWAPPER_1,
          owner
        ),
        COW_SWAPPER_2: MorigamiCowSwapper__factory.connect(
          ADDRS.MAINNET_TEST.SWAPPERS.COW_SWAPPER_2,
          owner
        ),
      },
    },
