...
import {
  ...
  OrigamiErc4626AndDexAggregatorSwapper__factory,
  IMorpho,
  IMorpho__factory,
...
export interface ContractInstances {
  ...
  ORACLES: {
    ANKRFLOW_WFLOW: OrigamiVolatileChainlinkOracle;
...
export function connectToContracts1(
  ...
  return {
    ...
    ORACLES: {
      ANKRFLOW_WFLOW: OrigamiVolatileChainlinkOracle__factory.connect(
        ADDRS.ORACLES.WETH_DAI,
        owner
      ),
      USDE_DAI: OrigamiStableChainlinkOracle__factory.connect(
        ADDRS.ORACLES.USDE_DAI,
        owner
      ),
      SUSDE_DAI: OrigamiErc4626Oracle__factory.connect(
        ADDRS.ORACLES.SUSDE_DAI,
        owner
      ),
      WEETH_WETH: OrigamiEtherFiEthToEthOracle__factory.connect(
        ADDRS.ORACLES.WEETH_WETH,
        owner
      ),
      EZETH_WETH: OrigamiRenzoEthToEthOracle__factory.connect(
        ADDRS.ORACLES.EZETH_WETH,
        owner
      ),
      STETH_WETH: OrigamiStableChainlinkOracle__factory.connect(
        ADDRS.ORACLES.STETH_WETH,
        owner
      ),
      WSTETH_WETH: OrigamiWstEthToEthOracle__factory.connect(
        ADDRS.ORACLES.WSTETH_WETH,
        owner
      ),
      WOETH_WETH: OrigamiErc4626Oracle__factory.connect(
        ADDRS.ORACLES.WOETH_WETH,
        owner
      ),
      WETH_DAI: OrigamiVolatileChainlinkOracle__factory.connect(
        ADDRS.ORACLES.WETH_DAI,
        owner
      ),
      WBTC_DAI: OrigamiVolatileChainlinkOracle__factory.connect(
        ADDRS.ORACLES.WBTC_DAI,
        owner
      ),
      WETH_WBTC: OrigamiVolatileChainlinkOracle__factory.connect(
        ADDRS.ORACLES.WETH_WBTC,
        owner
      ),
      WETH_SDAI: OrigamiCrossRateOracle__factory.connect(
        ADDRS.ORACLES.WETH_SDAI,
        owner
      ),
      WBTC_SDAI: OrigamiCrossRateOracle__factory.connect(
        ADDRS.ORACLES.WBTC_SDAI,
        owner
      ),
      DAI_USD: OrigamiStableChainlinkOracle__factory.connect(
        ADDRS.ORACLES.DAI_USD,
        owner
      ),
      SDAI_DAI: OrigamiErc4626Oracle__factory.connect(
        ADDRS.ORACLES.SDAI_DAI,
        owner
      ),
      PT_SUSDE_OCT24_USDE: OrigamiPendlePtToAssetOracle__factory.connect(
        ADDRS.ORACLES.PT_SUSDE_OCT24_USDE,
        owner
      ),
      PT_SUSDE_OCT24_DAI: OrigamiCrossRateOracle__factory.connect(
        ADDRS.ORACLES.PT_SUSDE_OCT24_DAI,
        owner
      ),
      PT_SUSDE_MAR_2025_USDE: OrigamiPendlePtToAssetOracle__factory.connect(
        ADDRS.ORACLES.PT_SUSDE_MAR_2025_USDE,
        owner
      ),
      PT_SUSDE_MAR_2025_DAI: OrigamiCrossRateOracle__factory.connect(
        ADDRS.ORACLES.PT_SUSDE_MAR_2025_DAI,
        owner
      ),
      PT_SUSDE_MAR_2025_DISCOUNT_TO_MATURITY:
        OrigamiVolatileChainlinkOracle__factory.connect(
          ADDRS.ORACLES.PT_SUSDE_MAR_2025_DISCOUNT_TO_MATURITY,
          owner
        ),
      PT_SUSDE_MAR_2025_DAI_WITH_DISCOUNT_TO_MATURITY:
        OrigamiScaledOracle__factory.connect(
          ADDRS.ORACLES.PT_SUSDE_MAR_2025_DAI_WITH_DISCOUNT_TO_MATURITY,
          owner
        ),
      MKR_DAI: OrigamiVolatileChainlinkOracle__factory.connect(
        ADDRS.ORACLES.MKR_DAI,
        owner
      ),
      AAVE_USDC: OrigamiVolatileChainlinkOracle__factory.connect(
        ADDRS.ORACLES.AAVE_USDC,
        owner
      ),
      SDAI_USDC: OrigamiErc4626Oracle__factory.connect(
        ADDRS.ORACLES.SDAI_USDC,
        owner
      ),
      USD0pp_USD0: OrigamiVolatileCurveEmaOracle__factory.connect(
        ADDRS.ORACLES.USD0pp_USD0,
        owner
      ),
      USD0pp_USDC: OrigamiFixedPriceOracle__factory.connect(
        ADDRS.ORACLES.USD0pp_USDC,
        owner
      ),
      USD0_USDC: OrigamiVolatileCurveEmaOracle__factory.connect(
        ADDRS.ORACLES.USD0_USDC,
        owner
      ),
      RSWETH_WETH: OrigamiVolatileChainlinkOracle__factory.connect(
        ADDRS.ORACLES.RSWETH_WETH,
        owner
      ),
      PT_EBTC_DEC24_EBTC: OrigamiPendlePtToAssetOracle__factory.connect(
        ADDRS.ORACLES.PT_EBTC_DEC24_EBTC,
        owner
      ),
      PT_CORN_LBTC_DEC24_LBTC: OrigamiPendlePtToAssetOracle__factory.connect(
        ADDRS.ORACLES.PT_CORN_LBTC_DEC24_LBTC,
        owner
      ),
      WETH_CBBTC: OrigamiVolatileChainlinkOracle__factory.connect(
        ADDRS.ORACLES.WETH_CBBTC,
        owner
      ),
    },
    SWAPPERS: {
      DIRECT_SWAPPER: OrigamiDexAggregatorSwapper__factory.connect(
        ADDRS.SWAPPERS.DIRECT_SWAPPER,
        owner
      ),
      SUSDE_SWAPPER: OrigamiErc4626AndDexAggregatorSwapper__factory.connect(
        ADDRS.SWAPPERS.SUSDE_SWAPPER,
        owner
      ),
    },
    FLASHLOAN_PROVIDERS: {
      SPARK: OrigamiAaveV3FlashLoanProvider__factory.connect(
        ADDRS.FLASHLOAN_PROVIDERS.SPARK,
        owner
      ),
    },
    LOV_TEST_ANKRFLOW_FLOW: {
      TOKEN: OrigamiLovToken__factory.connect(
        ADDRS.LOV_TEST_ANKRFLOW_FLOW.TOKEN,
        owner
      ),
      SPARK_BORROW_LEND: OrigamiAaveV3BorrowAndLend__factory.connect(
        ADDRS.LOV_TEST_ANKRFLOW_FLOW.SPARK_BORROW_LEND,
        owner
      ),
      MANAGER: OrigamiLovTokenFlashAndBorrowManager__factory.connect(
        ADDRS.LOV_TEST_ANKRFLOW_FLOW.MANAGER,
        owner
      ),
    },
    LOV_SUSDE_A: {
      MORPHO_BORROW_LEND: OrigamiMorphoBorrowAndLend__factory.connect(
        ADDRS.LOV_SUSDE_A.MORPHO_BORROW_LEND,
        owner
      ),
      TOKEN: OrigamiLovToken__factory.connect(ADDRS.LOV_SUSDE_A.TOKEN, owner),
      MANAGER: OrigamiLovTokenMorphoManager__factory.connect(
    ...
    LOV_PT_SUSDE_OCT24_A: {
      ...
      MANAGER: OrigamiLovTokenMorphoManagerMarketAL__factory.connect(
    ...
    LOV_PT_EBTC_DEC24_A: {
      ...
      ZEROLEND_BORROW_LEND: OrigamiAaveV3BorrowAndLend__factory.connect(
    ...
    VAULTS: {
      SUSDSpS: {
        TOKEN: OrigamiSuperSavingsUsdsVault__factory.connect(
          ADDRS.VAULTS.SUSDSpS.TOKEN,
          owner
        ),
        MANAGER: OrigamiSuperSavingsUsdsManager__factory.connect(
          ADDRS.VAULTS.SUSDSpS.MANAGER,
          owner
        ),
        COW_SWAPPER: OrigamiCowSwapper__factory.connect(
    ...
    MAINNET_TEST: {
      SWAPPERS: {
        COW_SWAPPER_1: OrigamiCowSwapper__factory.connect(
          ADDRS.MAINNET_TEST.SWAPPERS.COW_SWAPPER_1,
          owner
        ),
        COW_SWAPPER_2: OrigamiCowSwapper__factory.connect(
