    ...
    polygonMumbai: {
        ORIGAMI: {            
            ...
            GMX: {
                ...
                // yarn hardhat verify --network polygonMumbai 0x084E1ceB358Fc9A78BB2799424A407419F28F3cf 0xA7F0F04efB55eaEfBC4649C523F7a773f91D5526 "Morigami GMX Investment Vault" ovGMX 0x79Dd3E25E0ED4A8C375AEAE4813baAA145599e61 0xfB720eAa483beF207400D6561b5E17b8d6f2BB2f 5 604800
                ovGLP: '0xE781bF69e3dfaB3E7161B3f718897BcbDE17539a',
                // yarn hardhat verify --network polygonMumbai 0xE781bF69e3dfaB3E7161B3f718897BcbDE17539a 0xA7F0F04efB55eaEfBC4649C523F7a773f91D5526 "Morigami GLP Investment Vault" ovGLP 0xea5043b2C7cEA4720B9Ec622E96FD79C051B1Ded 0xfB720eAa483beF207400D6561b5E17b8d6f2BB2f 5 604800
...
export function getDeployedContracts(networkName: string): GmxDeployedContracts {
    if (GMX_DEPLOYED_CONTRACTS[networkName] === undefined) {
      console.log(`No contracts configured for ${networkName}`);
      throw new Error(`No contracts configured for ${networkName}`);
    } else {
      return GMX_DEPLOYED_CONTRACTS[networkName];
    }
}
