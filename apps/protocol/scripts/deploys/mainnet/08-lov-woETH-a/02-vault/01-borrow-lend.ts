...
async function main() {
  ...
  await deployAndMine(
    'LOV_WOETH_A.MORPHO_BORROW_LEND',
    factory,
    factory.deploy,
    ...
    ADDRS.EXTERNAL.MORPHO.ORACLE.WOETH_WETH,
    ADDRS.EXTERNAL.MORPHO.IRM,
    DEFAULT_SETTINGS.LOV_WOETH_A.MORPHO_BORROW_LEND.LIQUIDATION_LTV,
    DEFAULT_SETTINGS.LOV_WOETH_A.MORPHO_BORROW_LEND.SAFE_LTV,
  );
}
