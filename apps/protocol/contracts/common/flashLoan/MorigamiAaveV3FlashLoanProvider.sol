...
/**
 * @title MorigamiAaveV3FlashLoanProvider
 ...
 */ 
contract MorigamiAaveV3FlashLoanProvider is IMorigamiFlashLoanProvider, IFlashLoanReceiver {
    ...
    function flashLoan(IERC20 token, uint256 amount, bytes calldata params) external override {
        ...
        // Encode the msg.sender, which also doubles as the IMorigamiFlashLoanReceiver.
    ...
    */
    function executeOperation(
        ...
        (IMorigamiFlashLoanReceiver flReceiver, bytes memory _params) = abi.decode(params, (IMorigamiFlashLoanReceiver, bytes));
