...
// Morigami (common/oracle/MorigamiVolatileChainlinkOracle.sol)
...
/**
 * @title MorigamiVolatileChainlinkOracle
 ...
 */
contract MorigamiVolatileChainlinkOracle is MorigamiOracleBase {
    ...
    /**
     * @notice When using Morigami 'chainlink-like' oracle interfaces, the lastUpdatedAt
     * returned may be unused, and so validation isn't required in that case.
     */
