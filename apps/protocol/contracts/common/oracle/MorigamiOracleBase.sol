...
// Morigami (common/oracle/MorigamiOracleBase.sol)
...
/**
 * @title MorigamiOracleBase
 * @notice Common base logic for Morigami Oracle's
 */
abstract contract MorigamiOracleBase is IMorigamiOracle {
    ...
    /**
     * @notice A human readable description for this Morigami oracle
     */
    ...
    function latestPrices(
        ...
        MorigamiMath.Rounding roundingMode1,
        PriceType priceType2, 
        MorigamiMath.Rounding roundingMode2
    ...
    function convertAmount(
        ...
        if (fromAsset == baseAsset) {
            ...
            uint256 _price = latestPrice(
                priceType, 
                roundingMode == MorigamiMath.Rounding.ROUND_UP ? MorigamiMath.Rounding.ROUND_DOWN : MorigamiMath.Rounding.ROUND_UP
            );
