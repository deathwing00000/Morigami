...
// Morigami (common/oracle/MorigamiCrossRateOracle.sol)
 ...
 */
contract MorigamiCrossRateOracle is MorigamiOracleBase {
     ...
     */
    IMorigamiOracle public immutable baseAssetOracle;
    ...
    {
        baseAssetOracle = IMorigamiOracle(_baseAssetOracle);
