...
// Morigami (common/borrowAndLend/MorigamiMorphoBorrowAndLend.sol)
 ...
 */
contract MorigamiMorphoBorrowAndLend is IMorigamiMorphoBorrowAndLend, IMorphoSupplyCollateralCallback, MorigamiElevatedAccess {
    ...
    /**
     * @dev Factor when converting the Morpho LTV (1e18) to an Morigami Assets/Liabilities (1e18)
     */
    ...
    function debtAccountData() external override view returns (
        ...
        if (borrowed == 0) {
            ...
            healthFactor = maxBorrow.mulDiv(1e18, borrowed, MorigamiMath.Rounding.ROUND_DOWN);
        }
    }
