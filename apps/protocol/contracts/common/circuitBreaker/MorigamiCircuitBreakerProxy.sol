 ...
 */
contract MorigamiCircuitBreakerProxy is IMorigamiCircuitBreakerProxy, MorigamiElevatedAccess {
     ...
     */
    mapping(bytes32 identifier => mapping(address token => IMorigamiCircuitBreaker implementation)) public override circuitBreakers;
    ...
    function setCircuitBreaker(
        ...
        circuitBreakers[identifier][token] = IMorigamiCircuitBreaker(circuitBreaker);
    ...
    function cap(
        ...
        IMorigamiCircuitBreaker _impl = _getImpl(token, caller);
    ...
    function _getImpl(address token, address caller) internal view returns (IMorigamiCircuitBreaker) {
