...
// Morigami (common/circuitBreaker/MorigamiCircuitBreakerAllUsersPerPeriod.sol)
...
/**
 * @title Morigami Circuit Breaker -- total volumes (across all users) in a rolling period window
 *
 ...
 */
contract MorigamiCircuitBreakerAllUsersPerPeriod is IMorigamiCircuitBreaker, MorigamiElevatedAccess {
