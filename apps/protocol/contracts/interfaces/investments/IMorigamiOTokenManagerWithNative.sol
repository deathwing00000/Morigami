...
// Morigami (interfaces/investments/IMorigamiOTokenManagerWithNative.sol)
...
/**
 * @title Morigami oToken Manager (with native ETH/AVAX/etc)
 ...
 */
interface IMorigamiOTokenManagerWithNative is IMorigamiOTokenManager {
