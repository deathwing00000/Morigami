...
// Morigami (interfaces/investments/IMorigamiInvestment.sol)
 ...
 */
interface IMorigamiInvestment is IERC20Metadata, IERC20Permit {
     ...
     * @param investmentAmount The number of Morigami investment tokens sold
    ...
    struct InvestQuoteData {
        ...
        /// @notice The expected amount of this Morigami Investment token to receive in return
        uint256 expectedInvestmentAmount;

        /// @notice The minimum amount of this Morigami Investment Token to receive after
    ...
    /** 
      * @notice User buys this Morigami investment with an amount of native chain token (ETH/AVAX)
      * @param quoteData The quote data received from investQuote()
      * @return investmentAmount The actual number of this Morigami investment tokens received.
      */
    ...
    /** 
      * @notice Sell this Morigami investment to receive one of the accepted tokens.
