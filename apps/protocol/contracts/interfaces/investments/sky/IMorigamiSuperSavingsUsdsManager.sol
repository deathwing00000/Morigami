...
// Morigami (interfaces/sky/IMorigamiSuperSavingsUsdsManager.sol)
 ...
 */
interface IMorigamiSuperSavingsUsdsManager is IMorigamiDelegated4626VaultManager {
    ...
    struct Farm {
        ...
        /// @dev The referral code representing Morigami
        uint16 referral;
    }

    /**
     * @notice Set the performance fees for the caller and Morigami
    ...
    /**
     * @notice Set the address used to collect the Morigami performance fees.
     */
     ...
     * - Morigami will earn a portion of these rewards (as performance fee)
    ...
    /**
     * @notice The performance fee to the caller (to compensate for gas) and Morigami treasury
    ...
    /**
     * @notice The referral code representing Morigami when depositing into sUSDS
     */
