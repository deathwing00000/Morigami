...
// Morigami (interfaces/investments/lovToken/IMorigamiLovToken.sol)
 ...
 */
interface IMorigamiLovToken is IMorigamiInvestment {
    ...
    /**
     * @notice The annual performance fee to Morigami treasury
