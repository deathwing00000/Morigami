...
// Morigami (interfaces/investments/lending/idleStrategy/IMorigamiIdleStrategyManager.sol)
 ...
 */
interface IMorigamiIdleStrategyManager is IMorigamiLendingBorrower {
     ...
     * are deposited into.
     */
    function idleStrategy() external view returns (IMorigamiIdleStrategy);
