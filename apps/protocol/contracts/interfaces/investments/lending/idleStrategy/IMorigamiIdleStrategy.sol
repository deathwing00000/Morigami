...
// Morigami (interfaces/investments/lending/idleStrategy/IMorigamiIdleStrategy.sol)

import { IERC20 } from "@openzeppelin/contracts/token/ERC20/IERC20.sol";

/**
 * @notice An Morigami Idle Strategy, which can allocate and withdraw funds in 3rd
 * party protocols for yield and capital efficiency.
 */
interface IMorigamiIdleStrategy {
