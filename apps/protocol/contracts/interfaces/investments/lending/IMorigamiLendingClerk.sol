...
// Morigami (interfaces/investments/lending/IMorigamiLendingClerk.sol)
 ...
 */
interface IMorigamiLendingClerk {
     ...
     */
    function oToken() external view returns (IMorigamiOToken);

    /**
     * @notice Where idle funds (not yet borrowed) are deposited.
     */
    function idleStrategyManager() external view returns (IMorigamiIdleStrategyManager);
