...
// Morigami (interfaces/investments/gmx/IMorigamiGmxManager.sol)
...
interface IMorigamiGmxManager {
    ...
    function harvestableRewards(IMorigamiGmxEarnAccount.VaultType vaultType) external view returns (uint256[] memory amounts);
    ...
    function projectedRewardRates(IMorigamiGmxEarnAccount.VaultType vaultType) external view returns (uint256[] memory amounts);
