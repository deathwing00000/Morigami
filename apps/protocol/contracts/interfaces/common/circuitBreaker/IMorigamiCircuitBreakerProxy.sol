...
// Morigami (interfaces/common/circuitBreaker/IMorigamiCircuitBreakerProxy.sol)
 ...
 */
interface IMorigamiCircuitBreakerProxy {
    ...
    function circuitBreakers(
        bytes32 identifier, 
        address token
    ) external view returns (IMorigamiCircuitBreaker implementation);
