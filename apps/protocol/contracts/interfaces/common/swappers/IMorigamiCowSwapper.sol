...
// Morigami (interfaces/common/swappers/IMorigamiCowSwapper.sol)
 ...
 */
interface IMorigamiCowSwapper is IConditionalOrder {
    ...
    struct OrderConfig {
        ...
        /// @dev The Morigami oracle to lookup the limit order price.
        /// Not used if set to address(0)
        IMorigamiOracle limitPriceOracle;
