...
// Morigami (interfaces/common/flashLoan/IMorigamiFlashLoanReceiver.sol)

import { IERC20 } from "@openzeppelin/contracts/token/ERC20/IERC20.sol";

/**
 * @notice Handle Flash Loan callback's originated from a `IMorigamiFlashLoanProvider`
 */
interface IMorigamiFlashLoanReceiver {
    /**
