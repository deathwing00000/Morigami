...
// Morigami (investments/lending/idleStrategy/MorigamiAaveV3IdleStrategy.sol)
...
/**
 * @title Morigami Aave v3 Idle Strategy
 * @notice Supply asset into aave v3 for yield
 */
contract MorigamiAaveV3IdleStrategy is MorigamiAbstractIdleStrategy {
