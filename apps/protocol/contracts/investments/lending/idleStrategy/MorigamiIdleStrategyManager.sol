...
// Morigami (investments/lending/idleStrategy/MorigamiIdleStrategyManager.sol)
...
import { IMorigamiIdleStrategy } from "contracts/interfaces/investments/lending/idleStrategy/IMorigamiIdleStrategy.sol";

/**
 * @title Morigami Idle Strategy Manager
 ...
 * This manager is a 'borrower' of funds from the MorigamiLendingClerk, so will have an iToken debt
 * for any funds allocated into it.
 */
contract MorigamiIdleStrategyManager is IMorigamiIdleStrategyManager, MorigamiElevatedAccess {
     ...
     * are deposited into.
     */
    IMorigamiIdleStrategy public override idleStrategy;
    ...
    function setIdleStrategy(address _idleStrategy) external override onlyElevatedAccess {
        ...
        idleStrategy = IMorigamiIdleStrategy(_idleStrategy);
    ...
    function withdraw(uint256 amount, address recipient) external onlyElevatedAccess {
        ...
        uint256 _balance = asset.balanceOf(address(this));
        IMorigamiIdleStrategy _idleStrategy = idleStrategy;
