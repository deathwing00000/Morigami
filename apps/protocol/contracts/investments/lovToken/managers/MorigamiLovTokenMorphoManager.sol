...
// Morigami (investments/lovToken/managers/MorigamiLovTokenMorphoManager.sol)
...
import { IMorigamiMorphoBorrowAndLend } from "contracts/interfaces/common/borrowAndLend/IMorigamiMorphoBorrowAndLend.sol";
...
/**
 * @title Morigami LovToken Manager, for use with Morpho markets
 ...
 */
contract MorigamiLovTokenMorphoManager is IMorigamiLovTokenMorphoManager, MorigamiAbstractLovTokenManager {
     ...
     */
    IMorigamiMorphoBorrowAndLend public override borrowLend;
     ...
     */
    IMorigamiOracle public override dynamicFeePriceOracle;
    ...
    constructor(
        ...
        borrowLend = IMorigamiMorphoBorrowAndLend(_borrowLend);
    ...
    function setBorrowLend(address _address) external override onlyElevatedAccess {
        ...
        borrowLend = IMorigamiMorphoBorrowAndLend(_address);
    ...
    function _depositIntoReserves(address fromToken, uint256 fromTokenAmount) internal override returns (uint256 newReservesAmount) {
        if (fromToken == address(_reserveToken)) {
            ...
            IMorigamiMorphoBorrowAndLend _borrowLend = borrowLend;
