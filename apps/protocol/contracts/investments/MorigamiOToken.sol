...
// Morigami (investments/MorigamiOToken.sol)
...
/**
 * @title Morigami oToken (no native ETH support for deposits/exits)
 * 
 ...
 */
contract MorigamiOToken is MorigamiInvestment, IMorigamiOToken {
     ...
     */
    IMorigamiOTokenManager public override manager;
    ...
    /**
     * @notice Set the Morigami oToken Manager.
     */
    function setManager(address _manager) external override onlyElevatedAccess {
        ...
        manager = IMorigamiOTokenManager(_manager);
    }
    ...
    function investWithToken(
        ...
        IMorigamiOTokenManager _manager = manager;
